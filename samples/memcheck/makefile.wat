...
clean : .SYMBOLIC 
	...
	-del $(OBJS)\memcheck.exe

$(OBJS)\memcheck.exe :  $(MEMCHECK_OBJECTS)
	...
	@%append $(OBJS)\memcheck.lbc  $(__DEBUGINFO_1)  libpath $(LIBDIRNAME) system os2v2_pm $(LDFLAGS)
	@for %i in ($(MEMCHECK_OBJECTS)) do @%append $(OBJS)\memcheck.lbc file %i
	@for %i in ( $(__WXLIB_CORE_p)  $(__WXLIB_BASE_p)  $(__WXLIB_MONO_p) $(__LIB_TIFF_p) $(__LIB_JPEG_p) $(__LIB_PNG_p)  wxzlib$(WXDEBUGFLAG).lib  wxregex$(WXUNICODEFLAG)$(WXDEBUGFLAG).lib wxexpat$(WXDEBUGFLAG).lib $(EXTRALIBS_FOR_BASE) upm32.lib) do @%append $(OBJS)\memcheck.lbc library %i
	@%append $(OBJS)\memcheck.lbc
...
$(OBJS)\memcheck_memcheck.obj :  .AUTODEPEND .\memcheck.cpp
	$(CXX) -bt=os2 -zq -fo=$^@ $(MEMCHECK_CXXFLAGS) $<
