...
DYNAMIC_CXXFLAGS = $(CPPFLAGS) $(__DEBUGINFO_0) $(__OPTIMIZEFLAG_2) -bm &
...
$(OBJS)\dynamic.exe :  $(DYNAMIC_OBJECTS) $(OBJS)\dynamic_dynamic.res
	...
	@%append $(OBJS)\dynamic.lbc $(LDFLAGS) $(__DEBUGINFO_1)  libpath $(LIBDIRNAME) system nt_win ref '_WinMain@16'
