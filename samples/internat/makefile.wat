...
$(OBJS)\internat.exe :  $(INTERNAT_OBJECTS)
	...
	@%append $(OBJS)\internat.lbc  $(__DEBUGINFO_1)  libpath $(LIBDIRNAME) system os2v2_pm $(LDFLAGS)
	@for %i in ($(INTERNAT_OBJECTS)) do @%append $(OBJS)\internat.lbc file %i
	@for %i in ( $(__WXLIB_CORE_p)  $(__WXLIB_BASE_p)  $(__WXLIB_MONO_p) $(__LIB_TIFF_p) $(__LIB_JPEG_p) $(__LIB_PNG_p)  wxzlib$(WXDEBUGFLAG).lib  wxregex$(WXUNICODEFLAG)$(WXDEBUGFLAG).lib wxexpat$(WXDEBUGFLAG).lib $(EXTRALIBS_FOR_BASE) upm32.lib) do @%append $(OBJS)\internat.lbc library %i
	@%append $(OBJS)\internat.lbc
...
$(OBJS)\internat_internat.obj :  .AUTODEPEND .\internat.cpp
	$(CXX) -bt=os2 -zq -fo=$^@ $(INTERNAT_CXXFLAGS) $<
