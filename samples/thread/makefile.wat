...
THREAD_CXXFLAGS = $(CPPFLAGS) $(__DEBUGINFO_0) $(__OPTIMIZEFLAG_2) -bm &
...
$(OBJS)\thread.exe :  $(THREAD_OBJECTS) $(OBJS)\thread_thread.res
	...
	@%append $(OBJS)\thread.lbc $(LDFLAGS) $(__DEBUGINFO_1)  libpath $(LIBDIRNAME) system nt_win ref '_WinMain@16'
