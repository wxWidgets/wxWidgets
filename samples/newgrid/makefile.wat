...
NEWGRID_CXXFLAGS = $(CPPFLAGS) $(__DEBUGINFO_0) $(__OPTIMIZEFLAG_2) -bm &
...
$(OBJS)\newgrid.exe :  $(NEWGRID_OBJECTS) $(OBJS)\newgrid_newgrid.res
	@%create $(OBJS)\newgrid.lbc
	@%append $(OBJS)\newgrid.lbc option quiet
	@%append $(OBJS)\newgrid.lbc name $^@
	@%append $(OBJS)\newgrid.lbc option incremental
	@%append $(OBJS)\newgrid.lbc $(LDFLAGS) $(__DEBUGINFO_1)  libpath $(LIBDIRNAME) system nt_win ref '_WinMain@16'
	@for %i in ($(NEWGRID_OBJECTS)) do @%append $(OBJS)\newgrid.lbc file %i
