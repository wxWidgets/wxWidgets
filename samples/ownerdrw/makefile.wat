...
clean : .SYMBOLIC 
	...
	-del $(OBJS)\ownerdrw.exe

$(OBJS)\ownerdrw.exe :  $(OWNERDRW_OBJECTS)
	...
	@%append $(OBJS)\ownerdrw.lbc  $(__DEBUGINFO_1)  libpath $(LIBDIRNAME) system os2v2_pm $(LDFLAGS)
	@for %i in ($(OWNERDRW_OBJECTS)) do @%append $(OBJS)\ownerdrw.lbc file %i
	@for %i in ( $(__WXLIB_CORE_p)  $(__WXLIB_BASE_p)  $(__WXLIB_MONO_p) $(__LIB_TIFF_p) $(__LIB_JPEG_p) $(__LIB_PNG_p)  wxzlib$(WXDEBUGFLAG).lib  wxregex$(WXUNICODEFLAG)$(WXDEBUGFLAG).lib wxexpat$(WXDEBUGFLAG).lib $(EXTRALIBS_FOR_BASE) upm32.lib) do @%append $(OBJS)\ownerdrw.lbc library %i
	@%append $(OBJS)\ownerdrw.lbc
...
$(OBJS)\ownerdrw_ownerdrw.obj :  .AUTODEPEND .\ownerdrw.cpp
	$(CXX) -bt=os2 -zq -fo=$^@ $(OWNERDRW_CXXFLAGS) $<
