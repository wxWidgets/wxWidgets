...
WIDGET_CXXFLAGS = $(__DEBUGINFO_0) $(__OPTIMIZEFLAG_2) $(__THREADSFLAG_5) &
	...
	-i=.\..\..\..\samples -dNOPCH $(__RTTIFLAG_7) $(__EXCEPTIONSFLAG_8) &
	$(CPPFLAGS) $(CXXFLAGS)
WIDGET_OBJECTS =  &
...
$(OBJS)\widget.exe :  $(WIDGET_OBJECTS)
	...
	@%append $(OBJS)\widget.lbc  $(__DEBUGINFO_1)  libpath $(LIBDIRNAME) system os2v2_pm $(LDFLAGS)
	@for %i in ($(WIDGET_OBJECTS)) do @%append $(OBJS)\widget.lbc file %i
	@for %i in ( $(__WXLIB_HTML_p)  $(__WXLIB_CORE_p)  $(__WXLIB_BASE_p)  $(__WXLIB_MONO_p) $(__LIB_TIFF_p) $(__LIB_JPEG_p) $(__LIB_PNG_p)  wxzlib$(WXDEBUGFLAG).lib  wxregex$(WXUNICODEFLAG)$(WXDEBUGFLAG).lib wxexpat$(WXDEBUGFLAG).lib $(EXTRALIBS_FOR_BASE) upm32.lib) do @%append $(OBJS)\widget.lbc library %i
	@%append $(OBJS)\widget.lbc
...
$(OBJS)\widget_widget.obj :  .AUTODEPEND .\widget.cpp
	$(CXX) -bt=os2 -zq -fo=$^@ $(WIDGET_CXXFLAGS) $<
