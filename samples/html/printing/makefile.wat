...
HTMLPRINTING_CXXFLAGS = $(__DEBUGINFO_0) $(__OPTIMIZEFLAG_2) &
	$(__THREADSFLAG_5) $(__RUNTIME_LIBS_6) -d__WXPM__ $(__WXUNIV_DEFINE_p) &
...
clean : .SYMBOLIC 
	...
	-del $(OBJS)\htmlprinting.exe

$(OBJS)\htmlprinting.exe :  $(HTMLPRINTING_OBJECTS)
	...
	@%append $(OBJS)\htmlprinting.lbc  $(__DEBUGINFO_1)  libpath $(LIBDIRNAME) system os2v2_pm $(LDFLAGS)
	@for %i in ($(HTMLPRINTING_OBJECTS)) do @%append $(OBJS)\htmlprinting.lbc file %i
	@for %i in ( $(__WXLIB_HTML_p)  $(__WXLIB_CORE_p)  $(__WXLIB_BASE_p)  $(__WXLIB_MONO_p) $(__LIB_TIFF_p) $(__LIB_JPEG_p) $(__LIB_PNG_p)  wxzlib$(WXDEBUGFLAG).lib  wxregex$(WXUNICODEFLAG)$(WXDEBUGFLAG).lib wxexpat$(WXDEBUGFLAG).lib $(EXTRALIBS_FOR_BASE) upm32.lib) do @%append $(OBJS)\htmlprinting.lbc library %i
	@%append $(OBJS)\htmlprinting.lbc
...
$(OBJS)\htmlprinting_printing.obj :  .AUTODEPEND .\printing.cpp
	$(CXX) -bt=os2 -zq -fo=$^@ $(HTMLPRINTING_CXXFLAGS) $<
