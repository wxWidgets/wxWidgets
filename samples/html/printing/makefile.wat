...
PRINTING_CXXFLAGS = $(CPPFLAGS)  $(__DEBUGFLAG_0) $(__OPTIMIZEFLAG_2) -bm $(__RUNTIME_LIBS_5)  -d__WXMSW__ $(__WXUNIV_DEFINE_p) $(__DEBUG_DEFINE_p) $(__UNICODE_DEFINE_p) -i=.\..\..\..\include -i=.\..\..\..\lib\wat_$(PORTNAME)$(WXUNIVNAME)$(WXUNICODEFLAG)$(WXDEBUGFLAG)$(WXDLLFLAG)$(CFG) -i=.\..\..\..\src\tiff -i=.\..\..\..\src\jpeg -i=.\..\..\..\src\png -i=.\..\..\..\src\zlib  -i=.\..\..\..\src\regex -i=. $(__DLLFLAG_p) $(CXXFLAGS)
...
$(OBJS)\printing.exe :  $(OBJS)\printing_printing.obj $(OBJS)\printing_printing.res
	@%create $(OBJS)\printing.lbc
	@%append $(OBJS)\printing.lbc option quiet
	@%append $(OBJS)\printing.lbc name $^@
	@%append $(OBJS)\printing.lbc option incremental
	@%append $(OBJS)\printing.lbc $(LDFLAGS) $(__DEBUGFLAG_1)  libpath .\..\..\..\lib\wat_$(PORTNAME)$(WXUNIVNAME)$(WXUNICODEFLAG)$(WXDEBUGFLAG)$(WXDLLFLAG)$(CFG)  system nt_win ref '_WinMain@16'
	@for %i in ( $(OBJS)\printing_printing.obj) do @%append $(OBJS)\printing.lbc file %i
