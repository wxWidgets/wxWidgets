...
clean : .SYMBOLIC 
	...
	-del $(OBJS)\accesstest.exe

$(OBJS)\accesstest.exe :  $(ACCESSTEST_OBJECTS)
	...
	@%append $(OBJS)\accesstest.lbc  $(__DEBUGINFO_1)  libpath $(LIBDIRNAME) system os2v2_pm $(LDFLAGS)
	@for %i in ($(ACCESSTEST_OBJECTS)) do @%append $(OBJS)\accesstest.lbc file %i
	@for %i in ( $(__WXLIB_CORE_p)  $(__WXLIB_BASE_p)  $(__WXLIB_MONO_p) $(__LIB_TIFF_p) $(__LIB_JPEG_p) $(__LIB_PNG_p)  wxzlib$(WXDEBUGFLAG).lib  wxregex$(WXUNICODEFLAG)$(WXDEBUGFLAG).lib wxexpat$(WXDEBUGFLAG).lib $(EXTRALIBS_FOR_BASE) upm32.lib) do @%append $(OBJS)\accesstest.lbc library %i
	@%append $(OBJS)\accesstest.lbc
...
$(OBJS)\accesstest_accesstest.obj :  .AUTODEPEND .\accesstest.cpp
	$(CXX) -bt=os2 -zq -fo=$^@ $(ACCESSTEST_CXXFLAGS) $<
