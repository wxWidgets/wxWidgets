...
!ifeq SHARED 1
__renddll___depname = &
	$(OBJS)\renddll_$(PORTNAME)$(WXUNIVNAME)$(PLUGINSUFFIX)252_wat.dll
!endif
__DEBUGINFO =
!ifeq BUILD debug
...
clean : .SYMBOLIC 
	...
	-if exist $(OBJS)\renddll_$(PORTNAME)$(WXUNIVNAME)$(PLUGINSUFFIX)252_wat.dll del $(OBJS)\renddll_$(PORTNAME)$(WXUNIVNAME)$(PLUGINSUFFIX)252_wat.dll
...
!ifeq SHARED 1
$(OBJS)\renddll_$(PORTNAME)$(WXUNIVNAME)$(PLUGINSUFFIX)252_wat.dll :  $(RENDDLL_OBJECTS)
