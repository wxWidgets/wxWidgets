...
clean : .SYMBOLIC 
	...
	-del $(OBJS)\mediaplayer.exe

$(OBJS)\mediaplayer.exe :  $(MEDIAPLAYER_OBJECTS)
	...
	@%append $(OBJS)\mediaplayer.lbc  $(__DEBUGINFO_1)  libpath $(LIBDIRNAME) system os2v2_pm $(LDFLAGS)
	@for %i in ($(MEDIAPLAYER_OBJECTS)) do @%append $(OBJS)\mediaplayer.lbc file %i
	@for %i in ( $(__WXLIB_MEDIA_p)  $(__WXLIB_CORE_p)  $(__WXLIB_BASE_p)  $(__WXLIB_MONO_p) $(__LIB_TIFF_p) $(__LIB_JPEG_p) $(__LIB_PNG_p)  wxzlib$(WXDEBUGFLAG).lib  wxregex$(WXUNICODEFLAG)$(WXDEBUGFLAG).lib wxexpat$(WXDEBUGFLAG).lib $(EXTRALIBS_FOR_BASE) upm32.lib) do @%append $(OBJS)\mediaplayer.lbc library %i
	@%append $(OBJS)\mediaplayer.lbc
...
$(OBJS)\mediaplayer_mediaplayer.obj :  .AUTODEPEND .\mediaplayer.cpp
	$(CXX) -bt=os2 -zq -fo=$^@ $(MEDIAPLAYER_CXXFLAGS) $<
