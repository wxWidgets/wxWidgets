...
clean : .SYMBOLIC 
	...
	-del $(OBJS)\docvwmdi.exe

$(OBJS)\docvwmdi.exe :  $(DOCVWMDI_OBJECTS)
	...
	@%append $(OBJS)\docvwmdi.lbc  $(__DEBUGINFO_1)  libpath $(LIBDIRNAME) system os2v2_pm $(LDFLAGS)
	@for %i in ($(DOCVWMDI_OBJECTS)) do @%append $(OBJS)\docvwmdi.lbc file %i
	@for %i in ( $(__WXLIB_CORE_p)  $(__WXLIB_BASE_p)  $(__WXLIB_MONO_p) $(__LIB_TIFF_p) $(__LIB_JPEG_p) $(__LIB_PNG_p)  wxzlib$(WXDEBUGFLAG).lib  wxregex$(WXUNICODEFLAG)$(WXDEBUGFLAG).lib wxexpat$(WXDEBUGFLAG).lib $(EXTRALIBS_FOR_BASE) upm32.lib) do @%append $(OBJS)\docvwmdi.lbc library %i
	@%append $(OBJS)\docvwmdi.lbc
...
$(OBJS)\docvwmdi_docview.obj :  .AUTODEPEND .\docview.cpp
	$(CXX) -bt=os2 -zq -fo=$^@ $(DOCVWMDI_CXXFLAGS) $<
