...
clean : .SYMBOLIC 
	...
	-del $(OBJS)\splitter.exe

$(OBJS)\splitter.exe :  $(SPLITTER_OBJECTS)
	...
	@%append $(OBJS)\splitter.lbc  $(__DEBUGINFO_1)  libpath $(LIBDIRNAME) system os2v2_pm $(LDFLAGS)
	@for %i in ($(SPLITTER_OBJECTS)) do @%append $(OBJS)\splitter.lbc file %i
	@for %i in ( $(__WXLIB_CORE_p)  $(__WXLIB_BASE_p)  $(__WXLIB_MONO_p) $(__LIB_TIFF_p) $(__LIB_JPEG_p) $(__LIB_PNG_p)  wxzlib$(WXDEBUGFLAG).lib  wxregex$(WXUNICODEFLAG)$(WXDEBUGFLAG).lib wxexpat$(WXDEBUGFLAG).lib $(EXTRALIBS_FOR_BASE) upm32.lib) do @%append $(OBJS)\splitter.lbc library %i
	@%append $(OBJS)\splitter.lbc
...
$(OBJS)\splitter_splitter.obj :  .AUTODEPEND .\splitter.cpp
	$(CXX) -bt=os2 -zq -fo=$^@ $(SPLITTER_CXXFLAGS) $<
