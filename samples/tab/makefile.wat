...
TAB_CXXFLAGS = $(CPPFLAGS)  $(__DEBUGFLAG_0) $(__OPTIMIZEFLAG_2) -bm $(__RUNTIME_LIBS_5)  -d__WXMSW__ $(__WXUNIV_DEFINE_p) $(__DEBUG_DEFINE_p) $(__UNICODE_DEFINE_p) -i=.\..\..\include -i=.\..\..\lib\wat_$(PORTNAME)$(WXUNIVNAME)$(WXUNICODEFLAG)$(WXDEBUGFLAG)$(WXDLLFLAG)$(CFG) -i=.\..\..\src\tiff -i=.\..\..\src\jpeg -i=.\..\..\src\png -i=.\..\..\src\zlib  -i=.\..\..\src\regex -i=. $(__DLLFLAG_p) $(CXXFLAGS)
...
all : .SYMBOLIC $(OBJS)\tab.exe

$(OBJS)\tab_tab.obj :  .AUTODEPEND .\tab.cpp
	$(CXX) -zq -fo=$^@ $(TAB_CXXFLAGS) $<

$(OBJS)\tab_tab.res :  .AUTODEPEND .\tab.rc
...
$(OBJS)\tab.exe :  $(OBJS)\tab_tab.obj $(OBJS)\tab_tab.res
	@%create $(OBJS)\tab.lbc
	@%append $(OBJS)\tab.lbc option quiet
	@%append $(OBJS)\tab.lbc name $^@
	@%append $(OBJS)\tab.lbc option incremental
	@%append $(OBJS)\tab.lbc $(LDFLAGS) $(__DEBUGFLAG_1)  libpath .\..\..\lib\wat_$(PORTNAME)$(WXUNIVNAME)$(WXUNICODEFLAG)$(WXDEBUGFLAG)$(WXDLLFLAG)$(CFG)  system nt_win ref '_WinMain@16'
	@for %i in ( $(OBJS)\tab_tab.obj) do @%append $(OBJS)\tab.lbc file %i
	...
	@%append $(OBJS)\tab.lbc option resource=$(OBJS)\tab_tab.res
	wlink @$(OBJS)\tab.lbc
