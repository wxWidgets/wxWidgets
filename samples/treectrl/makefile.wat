...
clean : .SYMBOLIC 
	...
	-del $(OBJS)\treectrl.exe

$(OBJS)\treectrl.exe :  $(TREECTRL_OBJECTS)
	...
	@%append $(OBJS)\treectrl.lbc  $(__DEBUGINFO_1)  libpath $(LIBDIRNAME) system os2v2_pm $(LDFLAGS)
	@for %i in ($(TREECTRL_OBJECTS)) do @%append $(OBJS)\treectrl.lbc file %i
	@for %i in ( $(__WXLIB_CORE_p)  $(__WXLIB_BASE_p)  $(__WXLIB_MONO_p) $(__LIB_TIFF_p) $(__LIB_JPEG_p) $(__LIB_PNG_p)  wxzlib$(WXDEBUGFLAG).lib  wxregex$(WXUNICODEFLAG)$(WXDEBUGFLAG).lib wxexpat$(WXDEBUGFLAG).lib $(EXTRALIBS_FOR_BASE) upm32.lib) do @%append $(OBJS)\treectrl.lbc library %i
	@%append $(OBJS)\treectrl.lbc
	@for %i in () do @%append $(OBJS)\treectrl.lbc option stack=%i
	wlink @$(OBJS)\treectrl.lbc

$(OBJS)\treectrl_treetest.obj :  .AUTODEPEND .\treetest.cpp
	$(CXX) -bt=os2 -zq -fo=$^@ $(TREECTRL_CXXFLAGS) $<
