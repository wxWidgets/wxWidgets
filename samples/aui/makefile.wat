...
clean : .SYMBOLIC 
	...
	-del $(OBJS)\auidemo.exe

$(OBJS)\auidemo.exe :  $(AUIDEMO_OBJECTS)
	...
	@%append $(OBJS)\auidemo.lbc  $(__DEBUGINFO_1)  libpath $(LIBDIRNAME) system os2v2_pm $(LDFLAGS)
	@for %i in ($(AUIDEMO_OBJECTS)) do @%append $(OBJS)\auidemo.lbc file %i
	@for %i in ( $(__WXLIB_AUI_p)  $(__WXLIB_HTML_p)  $(__WXLIB_ADV_p)  $(__WXLIB_CORE_p)  $(__WXLIB_XML_p)  $(__WXLIB_BASE_p)  $(__WXLIB_MONO_p) $(__LIB_TIFF_p) $(__LIB_JPEG_p) $(__LIB_PNG_p)  wxzlib$(WXDEBUGFLAG).lib  wxregex$(WXUNICODEFLAG)$(WXDEBUGFLAG).lib wxexpat$(WXDEBUGFLAG).lib $(EXTRALIBS_FOR_BASE) upm32.lib) do @%append $(OBJS)\auidemo.lbc library %i
	@%append $(OBJS)\auidemo.lbc
	@for %i in () do @%append $(OBJS)\auidemo.lbc option stack=%i
	wlink @$(OBJS)\auidemo.lbc

$(OBJS)\auidemo_auidemo.obj :  .AUTODEPEND .\auidemo.cpp
	$(CXX) -bt=os2 -zq -fo=$^@ $(AUIDEMO_CXXFLAGS) $<
