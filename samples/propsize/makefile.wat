...
PROPSIZE_CXXFLAGS = $(CPPFLAGS) $(__DEBUGINFO_0) $(__OPTIMIZEFLAG_2) -bm &
...
$(OBJS)\propsize.exe :  $(PROPSIZE_OBJECTS) $(OBJS)\propsize_propsize.res
	...
	@%append $(OBJS)\propsize.lbc $(LDFLAGS) $(__DEBUGINFO_1)  libpath $(LIBDIRNAME) system nt_win ref '_WinMain@16'
