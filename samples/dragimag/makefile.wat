...
clean : .SYMBOLIC 
	...
	-del $(OBJS)\dragimag.exe

$(OBJS)\dragimag.exe :  $(DRAGIMAG_OBJECTS)
	...
	@%append $(OBJS)\dragimag.lbc  $(__DEBUGINFO_1)  libpath $(LIBDIRNAME) system os2v2_pm $(LDFLAGS)
	@for %i in ($(DRAGIMAG_OBJECTS)) do @%append $(OBJS)\dragimag.lbc file %i
	@for %i in ( $(__WXLIB_CORE_p)  $(__WXLIB_BASE_p)  $(__WXLIB_MONO_p) $(__LIB_TIFF_p) $(__LIB_JPEG_p) $(__LIB_PNG_p)  wxzlib$(WXDEBUGFLAG).lib  wxregex$(WXUNICODEFLAG)$(WXDEBUGFLAG).lib wxexpat$(WXDEBUGFLAG).lib $(EXTRALIBS_FOR_BASE) upm32.lib) do @%append $(OBJS)\dragimag.lbc library %i
	@%append $(OBJS)\dragimag.lbc
...
$(OBJS)\dragimag_dragimag.obj :  .AUTODEPEND .\dragimag.cpp
	$(CXX) -bt=os2 -zq -fo=$^@ $(DRAGIMAG_CXXFLAGS) $<
