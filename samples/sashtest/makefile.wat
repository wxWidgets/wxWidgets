...
clean : .SYMBOLIC 
	...
	-del $(OBJS)\sashtest.exe

$(OBJS)\sashtest.exe :  $(SASHTEST_OBJECTS)
	...
	@%append $(OBJS)\sashtest.lbc  $(__DEBUGINFO_1)  libpath $(LIBDIRNAME) system os2v2_pm $(LDFLAGS)
	@for %i in ($(SASHTEST_OBJECTS)) do @%append $(OBJS)\sashtest.lbc file %i
	@for %i in ( $(__WXLIB_ADV_p)  $(__WXLIB_HTML_p)  $(__WXLIB_XML_p)  $(__WXLIB_CORE_p)  $(__WXLIB_BASE_p)  $(__WXLIB_MONO_p) $(__LIB_TIFF_p) $(__LIB_JPEG_p) $(__LIB_PNG_p)  wxzlib$(WXDEBUGFLAG).lib  wxregex$(WXUNICODEFLAG)$(WXDEBUGFLAG).lib wxexpat$(WXDEBUGFLAG).lib $(EXTRALIBS_FOR_BASE) upm32.lib) do @%append $(OBJS)\sashtest.lbc library %i
	@%append $(OBJS)\sashtest.lbc
...
$(OBJS)\sashtest_sashtest.obj :  .AUTODEPEND .\sashtest.cpp
	$(CXX) -bt=os2 -zq -fo=$^@ $(SASHTEST_CXXFLAGS) $<
