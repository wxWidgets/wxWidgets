...
clean : .SYMBOLIC 
	...
	-del $(OBJS)\isosurf.exe

!ifeq USE_OPENGL 1
$(OBJS)\isosurf.exe :  $(ISOSURF_OBJECTS)
...
$(OBJS)\isosurf_isosurf.obj :  .AUTODEPEND .\isosurf.cpp
	$(CXX) -bt=os2 -zq -fo=$^@ $(ISOSURF_CXXFLAGS) $<
