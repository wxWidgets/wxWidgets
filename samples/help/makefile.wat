...
$(OBJS)\help.exe :  $(HELP_OBJECTS)
	@%create $(OBJS)\help.lbc
	@%append $(OBJS)\help.lbc option quiet
	@%append $(OBJS)\help.lbc name $^@
	@%append $(OBJS)\help.lbc option caseexact
	@%append $(OBJS)\help.lbc  $(__DEBUGINFO_1)  libpath $(LIBDIRNAME) system os2v2_pm $(LDFLAGS)
	@for %i in ($(HELP_OBJECTS)) do @%append $(OBJS)\help.lbc file %i
	@for %i in ( $(__WXLIB_HTML_p)  $(__WXLIB_ADV_p)  $(__WXLIB_CORE_p)  $(__WXLIB_BASE_p)  $(__WXLIB_MONO_p) $(__LIB_TIFF_p) $(__LIB_JPEG_p) $(__LIB_PNG_p)  wxzlib$(WXDEBUGFLAG).lib  wxregex$(WXUNICODEFLAG)$(WXDEBUGFLAG).lib wxexpat$(WXDEBUGFLAG).lib $(EXTRALIBS_FOR_BASE) upm32.lib) do @%append $(OBJS)\help.lbc library %i
	@%append $(OBJS)\help.lbc
...
$(OBJS)\help_demo.obj :  .AUTODEPEND .\demo.cpp
	$(CXX) -bt=os2 -zq -fo=$^@ $(HELP_CXXFLAGS) $<
