...
clean : .SYMBOLIC 
	...
	-del $(OBJS)\multimon_test.exe

$(OBJS)\multimon_test.exe :  $(MULTIMON_TEST_OBJECTS)
	...
	@%append $(OBJS)\multimon_test.lbc  $(__DEBUGINFO_1)  libpath $(LIBDIRNAME) system os2v2_pm $(LDFLAGS)
	@for %i in ($(MULTIMON_TEST_OBJECTS)) do @%append $(OBJS)\multimon_test.lbc file %i
	@for %i in ( $(__WXLIB_CORE_p)  $(__WXLIB_BASE_p)  $(__WXLIB_MONO_p) $(__LIB_TIFF_p) $(__LIB_JPEG_p) $(__LIB_PNG_p)  wxzlib$(WXDEBUGFLAG).lib  wxregex$(WXUNICODEFLAG)$(WXDEBUGFLAG).lib wxexpat$(WXDEBUGFLAG).lib $(EXTRALIBS_FOR_BASE) upm32.lib) do @%append $(OBJS)\multimon_test.lbc library %i
	@%append $(OBJS)\multimon_test.lbc
...
$(OBJS)\multimon_test_multimon_test.obj :  .AUTODEPEND .\multimon_test.cpp
	$(CXX) -bt=os2 -zq -fo=$^@ $(MULTIMON_TEST_CXXFLAGS) $<
