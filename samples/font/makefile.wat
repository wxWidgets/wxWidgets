...
FONT_CXXFLAGS = $(CPPFLAGS)  $(__DEBUGFLAG_0) $(__OPTIMIZEFLAG_2) -bm $(__RUNTIME_LIBS_5)  -d__WXMSW__ $(__WXUNIV_DEFINE_p) $(__DEBUG_DEFINE_p) $(__UNICODE_DEFINE_p) -i=.\..\..\include -i=.\..\..\lib\wat_$(PORTNAME)$(WXUNIVNAME)$(WXUNICODEFLAG)$(WXDEBUGFLAG)$(WXDLLFLAG)$(CFG) -i=.\..\..\src\tiff -i=.\..\..\src\jpeg -i=.\..\..\src\png -i=.\..\..\src\zlib  -i=.\..\..\src\regex -i=. $(__DLLFLAG_p) $(CXXFLAGS)
...
$(OBJS)\font.exe :  $(OBJS)\font_font.obj $(OBJS)\font_font.res
	@%create $(OBJS)\font.lbc
	@%append $(OBJS)\font.lbc option quiet
	@%append $(OBJS)\font.lbc name $^@
	@%append $(OBJS)\font.lbc option incremental
	@%append $(OBJS)\font.lbc $(LDFLAGS) $(__DEBUGFLAG_1)  libpath .\..\..\lib\wat_$(PORTNAME)$(WXUNIVNAME)$(WXUNICODEFLAG)$(WXDEBUGFLAG)$(WXDLLFLAG)$(CFG)  system nt_win ref '_WinMain@16'
	@for %i in ( $(OBJS)\font_font.obj) do @%append $(OBJS)\font.lbc file %i
	...
	@%append $(OBJS)\font.lbc option resource=$(OBJS)\font_font.res
	wlink @$(OBJS)\font.lbc
