...
clean : .SYMBOLIC 
	...
	-del $(OBJS)\conftest.exe

$(OBJS)\conftest.exe :  $(CONFTEST_OBJECTS)
	...
	@%append $(OBJS)\conftest.lbc  $(__DEBUGINFO_1)  libpath $(LIBDIRNAME) system os2v2_pm $(LDFLAGS)
	@for %i in ($(CONFTEST_OBJECTS)) do @%append $(OBJS)\conftest.lbc file %i
	@for %i in ( $(__WXLIB_CORE_p)  $(__WXLIB_BASE_p)  $(__WXLIB_MONO_p) $(__LIB_TIFF_p) $(__LIB_JPEG_p) $(__LIB_PNG_p)  wxzlib$(WXDEBUGFLAG).lib  wxregex$(WXUNICODEFLAG)$(WXDEBUGFLAG).lib wxexpat$(WXDEBUGFLAG).lib $(EXTRALIBS_FOR_BASE) upm32.lib) do @%append $(OBJS)\conftest.lbc library %i
	@%append $(OBJS)\conftest.lbc
...
$(OBJS)\conftest_conftest.obj :  .AUTODEPEND .\conftest.cpp
	$(CXX) -bt=os2 -zq -fo=$^@ $(CONFTEST_CXXFLAGS) $<
