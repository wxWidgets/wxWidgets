...
bool wxQtEventLoopBase::Pending() const
{
    ...
    //
    // So, in the absence of a replacement for these functions, we assume that there are
    // always pending events and rely on Dispatch() to process them if there are indeed
