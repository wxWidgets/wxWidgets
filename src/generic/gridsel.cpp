...
{
    if ( m_selectionMode == wxGrid::wxGridSelectColumns || m_selectionMode == wxGrid::wxGridSelectNone)
        return;
...
{
    if ( m_selectionMode == wxGrid::wxGridSelectRows || m_selectionMode == wxGrid::wxGridSelectNone)
        return;
