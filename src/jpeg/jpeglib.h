...
typedef struct {
   ...
   */
  wxjpeg_boolean component_needed;
...
struct jpeg_compress_struct {
  ...
  wxjpeg_boolean do_fancy_downsampling; /* TRUE=apply fancy downsampling */
...
struct jpeg_decompress_struct {
  ...
  wxjpeg_boolean is_baseline;		/* TRUE if Baseline SOF0 encountered */
