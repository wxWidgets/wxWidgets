/////////////////////////////////////////////////////////////////////////////
// Name:        src/commun/maskedfield.cpp
...
wxMaskedEdit::wxMaskedEdit(const wxMaskedEdit& maskedEdit)
{
    ...
    SetEmptyBackgroundColour(maskedEdit.GetEmptyBackgroundColour());
    SetValidBackgroundColour(maskedEdit.GetValidBackgroundColour());
    SetInvalidBackgroundColour(maskedEdit.GetInvalidBackgroundColour());
...
bool wxMaskedEdit::IsCharValid(wxChar charTest, unsigned int index)
{
    unsigned int fieldIndex = GetFieldIndex(index-1);
    wxString fieldMask = m_mask[fieldIndex]->GetMask();
    wxChar maskChar = fieldMask[index - 1  - GetMinFieldPosition(fieldIndex)];

    return m_mask[fieldIndex]->IsCharValid(maskChar, charTest);
}
