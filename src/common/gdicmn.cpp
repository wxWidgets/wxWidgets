...
void wxColourDatabase::Initialize()
{
    ...
    static const wxColourDesc legacyColours[] =
    {
        ...
        {"INDIANRED", 79, 47, 47},
        {"KHAKI", 159, 159, 95},
        {"LIGHTBLUE", 191, 216, 216},
        {"LIGHTGRAY", 192, 192, 192},
        {"LIGHTGREY", 192, 192, 192},
        {"LIGHTSTEELBLUE", 143, 143, 188},
        {"LIMEGREEN", 50, 204, 50},
        {"LIGHTMAGENTA", 255, 119, 255},
        {"MAROON", 142, 35, 107},
        {"MEDIUMAQUAMARINE", 50, 204, 153},
...
wxColour wxColourDatabase::Find(const wxString& colour) const
{
    ...
    // make the comparison case insensitive and disregard any spaces in the
    // name: we want "light grey" match the corresponding colour and discarding
    // all spaces is much simpler than any alternative
