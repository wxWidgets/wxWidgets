/////////////////////////////////////////////////////////////////////////////
// Name:        src/mobile/generic/mo_vlbox_g.cpp
// Purpose:     wxMoVListBox class
// Author:      Julian Smart
// Modified by:
// Created:     2009-06-07
// RCS-ID:      $Id$
// Copyright:   (c) 2003 Vadim Zeitlin <vadim@wxwidgets.org>, Julian Smart
                        ...
                        const wxString& name)
{
    ...
    if ( !wxMoVScrolledWindow::Create(parent, id, pos, size, style, name) )
        return false;
...
bool wxMoVListBox::DoSetCurrent(int current)
{
    wxASSERT_MSG( current == wxNOT_FOUND ||
                  ...
                  _T("wxMoVListBox::DoSetCurrent(): invalid item index") );
...
void wxMoVListBox::SetSelection(int selection)
{
    wxCHECK_RET( selection == wxNOT_FOUND ||
                  ...
                  _T("wxMoVListBox::SetSelection(): invalid item index") );
