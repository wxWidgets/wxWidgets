...
TEST_CASE_METHOD(ImageHandlersInit, "wxImage::BMP", "[image][bmp]")
{
    ...
    SECTION("RLE absolute run past right edge")
    {
        // A 4x4 8bpp RLE BMP whose absolute-mode escape claims 100 pixels
        // for a 4-pixel-wide row. The decode loop used to write past the
        // current scanline, overrunning the image buffer on the last row.
        static const unsigned char data[] =
        {
            0x42,0x4d,0xa6,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x3e,0x00,
