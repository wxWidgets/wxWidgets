...
//      validator needs to handle wxEVT_TEXT event (generated by SetValue())
//      to do the required validity checking on the entered value and update
//      its internal state accordingly.
//      Notice also that TransferToWindow() internally calls SetValue().
...
void NumValidatorTestCase::TransferInt()
{
    ...
    CPPUNIT_ASSERT( valInt.Validate(NULL) );
    ...
    m_text->SetValue("9223372036854775808"); // == LLONG_MAX + 1
    CPPUNIT_ASSERT( !valInt.Validate(NULL) );
    CPPUNIT_ASSERT( !valInt.TransferFromWindow() );
...
void NumValidatorTestCase::TransferUnsigned()
{
    ...
    CPPUNIT_ASSERT( valUnsigned.Validate(NULL) );
    CPPUNIT_ASSERT_EQUAL( "0", m_text->GetValue() );
    ...
    m_text->SetValue("18446744073709551616"); // == ULLONG_MAX + 1
    CPPUNIT_ASSERT( !valUnsigned.Validate(NULL) );
    CPPUNIT_ASSERT( !valUnsigned.TransferFromWindow() );
...
void NumValidatorTestCase::TransferFloat()
{
    ...
    CPPUNIT_ASSERT( valFloat.Validate(NULL) );
