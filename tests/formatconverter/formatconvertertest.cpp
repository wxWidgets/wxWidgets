...
TEST_CASE("format_d", "[formatconverter]")
{
    doTest("d", "d", "d", "d", "d");
...
TEST_CASE("format_ld", "[formatconverter]")
{
...
TEST_CASE("format_s", "[formatconverter]")
{
    doTest("s", "ls", "s", "ls", "s");
...
TEST_CASE("format_hs", "[formatconverter]")
{
    doTest("hs", "hs", "s", "ls", "s");
...
TEST_CASE("format_ls", "[formatconverter]")
{
    doTest("ls", "ls", "s", "ls", "s");
...
TEST_CASE("format_c", "[formatconverter]")
{
    doTest("c", "lc", "lc", "lc", "c");
...
TEST_CASE("format_hc", "[formatconverter]")
{
...
TEST_CASE("format_lc", "[formatconverter]")
{
