...
bool MobileTestsWxTextCtrlPanel::CreateControls()
{
    ...
    m_textCtrlNormal = new wxTextCtrl(this, wxID_ANY, "Normal");
    ...
    m_textCtrlLimitedTo10Chars = new wxTextCtrl(this, wxID_ANY, "10 chars");
    m_textCtrlLimitedTo10Chars->SetMaxLength(10);
    textCtrlSizer->Add(m_textCtrlLimitedTo10Chars, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5);
    
    m_textCtrlMultiLine = new wxTextCtrl(this, wxID_ANY, "Multi line", wxDefaultPosition, wxDefaultSize, wxTE_MULTILINE);
