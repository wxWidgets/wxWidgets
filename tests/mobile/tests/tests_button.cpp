...
bool MobileTestsWxButtonPanel::CreateControls()
{
    ...
    wxButton* m_buttonDisclosure = new wxButton(this, wxID_ANY, "This text should not be shown.", wxPoint(0, 40), wxDefaultSize, wxBU_DISCLOSURE);
    buttonSizer->Add(m_buttonDisclosure, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5);
    
    wxButton* m_buttonInfoLight = new wxButton(this, wxID_ANY, "This text should not be shown.", wxPoint(0, 80), wxDefaultSize, wxBU_INFO_LIGHT);
    buttonSizer->Add(m_buttonInfoLight, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5);
    
    wxButton* m_buttonInfoDark = new wxButton(this, wxID_ANY, "This text should not be shown.", wxPoint(0, 120), wxDefaultSize, wxBU_INFO_DARK);
    buttonSizer->Add(m_buttonInfoDark, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5);    
    
    wxButton* m_buttonContactAdd = new wxButton(this, wxID_ANY, "This text should not be shown.", wxPoint(0, 160), wxDefaultSize, wxBU_CONTACT_ADD);
