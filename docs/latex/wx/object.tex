...
Returns the informations for this class when the class has been described using the
\helpref{wxDECLARE\_CLASS}{wxdeclareclass} and \helpref{wxIMPLEMENT\_CLASS}{wximplementclass}
macros or their variants or \NULL if the class has no XTI description.

\wxheading{See also}

\helpref{XTI system overview}{runtimeclassoverview},\rtfsp
\helpref{XTI macros}{rttimacros},\rtfsp
