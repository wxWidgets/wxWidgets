...
\membersection{wxVListBox::GetItemRect}\label{wxvlistboxgetitemrect}

\constfunc{wxRect}{GetItemRect}{\param{size_t }{line}}

Returns the position and size of the given line, or the empty rectangle if the line is not visible.
