...
\membersection{wxRichTextCtrl::ForceDelayedLayout}\label{wxrichtextctrlforcedelayedlayout}

\func{void}{ForceDelayedLayout}{\void}

Call this function to ensure that the buffer is laid out fully even if there is a delayed layout operation pending on a large buffer.
