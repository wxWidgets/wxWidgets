...
A complete list of third-party tools that write to XRC can be found at \urlref{www.wxwidgets.org/wiki/index.php/Tools}{http://www.wxwidgets.org/wiki/index.php/Tools}.
