...
You need to make sure to use the \helpref{wxDECLARE\_CLASS}{wxdeclareclass} and 
\helpref{wxIMPLEMENT\_CLASS}{wximplementclass} macros.
...
to use a force link hack (see \helpref{wxFORCE\_LINK\_THIS\_MODULE}{wxforcelinkthismodule}
and \helpref{wxFORCE\_LINK\_MODULE}{wxforcelinkmodule} macros).
