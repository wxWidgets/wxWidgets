...
(see \urlref{W3C specifications}{http://www.w3.org/TR/2001/REC-SVG-20010904/}).
This format can be read by a range of programs, including a Netscape plugin (Adobe), full details 
in the \urlref{SVG Implementation and Resource Directory}{http://www.svgi.org}.
...
to the screen display context, wxSVGFileDC, by passing the wxSVGFileDC as a parameter instead of a wxSVGFileDC. Thus the wxSVGFileDC is a write-only class.
...
\urlref{wxArt2D website}{http://wxart2d.sourceforge.net/}.
