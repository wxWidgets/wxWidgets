...
Allows a native SQL command to be executed directly against the datasource.  Use of this command allows a user to (potentially) utilize features specific to the datasource they are connected to that may not be available through ODBC, as the ODBC driver will pass the specified command directly to the datasource.
