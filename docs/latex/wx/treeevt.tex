...
\membersection{wxTreeEvent::m\_item}

\member{wxTreeItemId}{m\_item}

The item of interest.

\membersection{wxTreeEvent::m\_oldItem}

\member{wxTreeItemId}{m\_oldItem}
...
\membersection{wxTreeEvent::GetCode}\label{wxtreeeventgetcode}
...
\constfunc{wxTreeItemId}{GetPoint}{\void}
