...
\helpref{wxCLASSINFO}{wxclassinfomacro}\\
...
\membersection{wxCLASSINFO}\label{wxclassinfomacro}
...
If you use this macro, you'll also need to use one of the \tt{wxIMPLEMENT_ABSTRACT_*} macros
...
If you use this macro, you'll also need to use one of the \tt{wxIMPLEMENT_DYNAMIC_*} macros
in the C++ source file.
...
Used in a C++ implementation file to complete the declaration of a class that has the
\helpref{wxDECLARE\_ABSTRACT\_CLASS}{wxdeclareabstractclass} macro in its definition.
...
a class that has the \helpref{wxDECLARE\_ABSTRACT\_CLASS}{wxdeclareabstractclass}
...
Used in a C++ implementation file to complete the declaration of
a class that has the \helpref{wxDECLARE\_DYNAMIC\_CLASS}{wxdeclaredynamicclass}
