...
\helpref{wxCLASSINFO}{wxclassinfo}\\
...
\helpref{wxDECLARE\_ABSTRACT\_CLASS}{wxdeclareabstractclass}\\
\helpref{wxDECLARE\_APP}{wxdeclareapp}\\
\helpref{wxDECLARE\_CLASS}{wxdeclareclass}\\
\helpref{wxDECLARE\_DYNAMIC\_CLASS}{wxdeclaredynamicclass}\\
...
\helpref{wxIMPLEMENT\_ABSTRACT\_CLASS2}{wximplementabstractclass2}\\
\helpref{wxIMPLEMENT\_ABSTRACT\_CLASS}{wximplementabstractclass}\\
\helpref{wxIMPLEMENT\_APP}{wximplementapp}\\
\helpref{wxIMPLEMENT\_CLASS2}{wximplementclass2}\\
\helpref{wxIMPLEMENT\_CLASS}{wximplementclass}\\
\helpref{wxIMPLEMENT\_DYNAMIC\_CLASS2}{wximplementdynamicclass2}\\
...
Some string-related functions. You will rarely use these ones; rather use \helpref{wxString}{wxstring}.
...
Use the \helpref{wxClipboard}{wxclipboard} class instead.
...
See the \helpref{XTI overview}{runtimeclassoverview} for more info.
...
\membersection{wxCLASSINFO}\label{classinfo}

\func{wxClassInfo *}{wxCLASSINFO}{className}

Returns a pointer to the wxClassInfo object associated with classes of type \tt{className}.


\membersection{wxDECLARE\_ABSTRACT\_CLASS}\label{wxdeclareabstractclass}

\func{}{wxDECLARE\_ABSTRACT\_CLASS}{className}

Used inside a class declaration to declare that the class should be
made known to the class hierarchy, but objects of this class cannot be created
dynamically (because they are abstract, that is, contain one or more abstract
virtual function). 
The same as \helpref{wxDECLARE\_CLASS}{wxdeclareclass}.
...
\membersection{wxDECLARE\_CLASS}\label{wxdeclareclass}

\func{}{wxDECLARE\_CLASS}{className}

Used inside a class declaration to declare that the class should be
made known to the class hierarchy, but objects of this class cannot be created
dynamically. The same as \helpref{wxDECLARE\_ABSTRACT\_CLASS}{wxdeclareabstractclass}.


\membersection{wxDECLARE\_DYNAMIC\_CLASS}\label{wxdeclaredynamicclass}

\func{}{wxDECLARE\_DYNAMIC\_CLASS}{className}
...
\membersection{wxDECLARE\_DYNAMIC\_CLASS\_NO\_ASSIGN}\label{wxdeclaredynamicclassnoassign}

\func{}{wxDECLARE\_DYNAMIC\_CLASS\_NO\_ASSIGN}{className}

Like the \helpref{wxDECLARE\_DYNAMIC\_CLASS}{wxdeclaredynamicclass}
macro but also declares \tt{className} as a class whose \tt{operator=} is private
and thus cannot be used. 

This is very useful to avoid that the user tries to assign to a variable 
...
Use the \helpref{wxDECLARE\_DYNAMIC\_CLASS\_NO\_COPY}{wxdeclaredynamicclassnocopy} 
...
\membersection{wxDECLARE\_DYNAMIC\_CLASS\_NO\_COPY}\label{wxdeclaredynamicclassnocopy}

\func{}{wxDECLARE\_DYNAMIC\_CLASS\_NO\_COPY}{className}
...
\membersection{wxIMPLEMENT\_ABSTRACT\_CLASS}\label{wximplementabstractclass}

\func{}{wxIMPLEMENT\_ABSTRACT\_CLASS}{className, baseClassName}
...
The same as \helpref{wxIMPLEMENT\_CLASS}{wximplementclass}.
...
\membersection{wxIMPLEMENT\_ABSTRACT\_CLASS2}\label{wximplementabstractclass2}

\func{}{wxIMPLEMENT\_ABSTRACT\_CLASS2}{className, baseClassName1, baseClassName2}

Used in a C++ implementation file to complete the declaration of
a class that has the 
\helpref{wxDECLARE\_ABSTRACT\_CLASS2}{wxdeclareabstractclass2}
macro in its definition and has two base classes. 

The same as \helpref{wxIMPLEMENT\_CLASS2}{wximplementclass2}.


\membersection{wxIMPLEMENT\_CLASS}\label{wximplementclass}

\func{}{wxIMPLEMENT\_CLASS}{className, baseClassName}
...
The same as \helpref{wxIMPLEMENT\_ABSTRACT\_CLASS}{wximplementabstractclass}.


\membersection{wxIMPLEMENT\_CLASS2}\label{wximplementclass2}

\func{}{wxIMPLEMENT\_CLASS2}{className, baseClassName1, baseClassName2}

Used in a C++ implementation file to complete the declaration of a
class that has the
\helpref{wxDECLARE\_CLASS2}{wxdeclareclass2}
macro in its definition and has two base classes.

The same as \helpref{wxIMPLEMENT\_ABSTRACT\_CLASS2}{wximplementabstractclass2}.


\membersection{wxIMPLEMENT\_DYNAMIC\_CLASS}\label{wximplementdynamicclass}

\func{}{wxIMPLEMENT\_DYNAMIC\_CLASS}{className, baseClassName}
...
\membersection{wxIMPLEMENT\_DYNAMIC\_CLASS\_XTI}\label{wximplementdynamicclassxti}

\func{}{wxIMPLEMENT\_DYNAMIC\_CLASS\_XTI}{className, baseClassName, headerFile}

Like \helpref{wxIMPLEMENT\_DYNAMIC\_CLASS}{wximplementdynamicclass} but with two
...
\helpref{wxPROPERTY}{wxproperty}, \helpref{wxHANDLER}{wxhandler} and
\helpref{wxCONSTRUCTOR\_N}{wxconstructorn} macros.

For a full example see the \helpref{XTI overview}{runtimeclassoverview}.


\membersection{wxIMPLEMENT\_DYNAMIC\_CLASS2}\label{wximplementdynamicclass2}

\func{}{wxIMPLEMENT\_DYNAMIC\_CLASS2}{className, baseClassName1, baseClassName2}

Used in a C++ implementation file to complete the declaration of
a class that has the
\helpref{wxDECLARE\_DYNAMIC\_CLASS2}{wxdeclaredynamicclass2}
macro in its definition, and whose instances can be created dynamically. 

Use this for classes derived from two base classes.


\membersection{wxIMPLEMENT\_DYNAMIC\_CLASS2\_XTI}\label{wximplementdynamicclass2xti}

\func{}{wxIMPLEMENT\_DYNAMIC\_CLASS2\_XTI}{className, baseClassName1, baseClassName2, headerFile}

Like \helpref{wxIMPLEMENT\_DYNAMIC\_CLASS2}{wximplementdynamicclass2} but with two
differences: this macro also takes the header name containing the class definition and,
more important, when you use this macro you'll need also to define the properties, the
handlers and the constructor using respectively the
\helpref{wxPROPERTY}{wxproperty}, \helpref{wxHANDLER}{wxhandler} and
...
the cast is to the type \arg{T} and not to \texttt{T *} and also the order of
...
\membersection{wxBEGIN\_HANDLERS\_TABLE}\label{wxbeginhandlerstable}

\func{}{wxBEGIN\_HANDLERS\_TABLE}{className}

Marks the beginning of the table of registered handlers for \tt{className}.
After using the \helpref{wxHANDLER}{wxhandler} macros, use the
\helpref{wxEND\_HANDLERS\_TABLE}{wxendhandlerstable} macro 
to mark the end of the table.

For a full example see the \helpref{XTI overview}{runtimeclassoverview}.


\membersection{wxHANDLER}\label{wxhandler}

\func{}{wxHANDLER}{className, eventClassType}

To be used inside the \helpref{wxBEGIN\_HANDLERS\_TABLE}{wxbeginhandlerstable}
and \helpref{wxEND\_HANDLERS\_TABLE}{wxendhandlerstable} macros.
Declares an handler for \tt{className} for events of type \tt{eventClassType}.

For a full example see the \helpref{XTI overview}{runtimeclassoverview}.


\membersection{wxEND\_HANDLERS\_TABLE}\label{wxendhandlerstable}

\func{}{wxEND\_HANDLERS\_TABLE}{}

Marks the end of the table of registered handlers for some class.
See \helpref{wxBEGIN\_HANDLERS\_TABLE}{wxbeginhandlerstable}.

For a full example see the \helpref{XTI overview}{runtimeclassoverview}.


\membersection{wxCONSTRUCTOR\_N}\label{wxconstructorn}

\func{}{wxCONSTRUCTOR\_0}{className}\\
\func{}{wxCONSTRUCTOR\_1}{className, type0, var0}\\
\func{}{wxCONSTRUCTOR\_2}{className, type0, var0, type1, var1}\\
\func{}{wxCONSTRUCTOR\_3}{className, type0, var0, type1, var1, type2, var2}\\
...\\
\func{}{wxCONSTRUCTOR\_N}{className, type0, var0, type1, var1, ..., typeN, varN}
...
This macro allows the \helpref{wxClassInfo}{wxclassinfo} instance relative to
...
semantic, rather use \helpref{wxDIRECT\_CONSTRUCTOR\_N}{wxdirectconstructorn}.
...
\membersection{wxDIRECT\_CONSTRUCTOR\_N}\label{wxdirectconstructorn}

\func{}{wxDIRECT\_CONSTRUCTOR\_0}{className}\\
\func{}{wxDIRECT\_CONSTRUCTOR\_1}{className, type0, var0}\\
\func{}{wxDIRECT\_CONSTRUCTOR\_2}{className, type0, var0, type1, var1}\\
\func{}{wxDIRECT\_CONSTRUCTOR\_3}{className, type0, var0, type1, var1, type2, var2}\\
...\\
\func{}{wxDIRECT\_CONSTRUCTOR\_N}{className, type0, var0, type1, var1, ..., typeN, varN}

Like \helpref{wxCONSTRUCTOR\_N}{wxconstructorn} macros but these macros declare a constructor
...
\membersection{wxBEGIN\_PROPERTIES\_TABLE}\label{wxbeginpropertiestable}

\func{}{wxBEGIN\_PROPERTIES\_TABLE}{className}

Marks the beginning of the table of registered properties for \tt{className}.
After using the \helpref{wxPROPERTY}{wxproperty} macros, use the
\helpref{wxEND\_PROPERTIES\_TABLE}{wxendpropertiestable} macro 
to mark the end of the table.

For a full example see the \helpref{XTI overview}{runtimeclassoverview}.


\membersection{wxPROPERTY}\label{wxproperty}

\func{}{wxPROPERTY}{propName, propType, setter, getter, defaultValue, flags, helpString, groupString}

To be used inside the \helpref{wxBEGIN\_PROPERTIES\_TABLE}{wxbeginpropertiestable}
and \helpref{wxEND\_PROPERTIES\_TABLE}{wxendpropertiestable} macros.
...
You can associate to this property also some \tt{flags} (see \helpref{wxPropertyInfo}{wxpropertyinfo}
...
\membersection{wxPROPERTY\_FLAGS}\label{wxpropertyflags}

\func{}{wxPROPERTY\_FLAGS}{propName, flagsEnumName, flagsType, setter, getter, defaultValue, flags, helpString, groupString}

Like \helpref{wxPROPERTY}{wxproperty} macro but declares a property whose value
...
\membersection{wxEND\_PROPERTIES\_TABLE}\label{wxendpropertiestable}

\func{}{wxEND\_PROPERTIES\_TABLE}{}

Marks the end of the table of registered handlers for some class.
See \helpref{wxBEGIN\_PROPERTIES\_TABLE}{wxbeginpropertiestable}.

For a full example see the \helpref{XTI overview}{runtimeclassoverview}.


\membersection{wxBEGIN\_ENUM}\label{wxbeginenum}

\func{}{wxBEGIN\_ENUM}{enumName}

Marks the beginning of the table of possible enumeration values for \tt{enumName}.
After using the \helpref{wxENUM\_MEMBER}{wxenummember} macros, use the
\helpref{wxEND\_ENUM}{wxendenum} macro to mark the end of the table.

For a full example see the \helpref{XTI overview}{runtimeclassoverview}.


\membersection{wxENUM\_MEMBER}\label{wxenummember}

\func{}{wxENUM\_MEMBER}{value}

Declares an enumeration value named \tt{value}.


\membersection{wxEND\_ENUM}\label{wxendenum}

\func{}{wxEND\_ENUM}{enumName}
...
\membersection{wxBEGIN\_FLAGS}\label{wxbeginflags}

\func{}{wxBEGIN\_FLAGS}{flagsName}

Marks the beginning of the table of possible flags for \tt{flagsName}.
After using the \helpref{wxFLAGS\_MEMBER}{wxflagsmember} macros, use the
\helpref{wxEND\_FLAGS}{wxendflags} macro to mark the end of the table.

For a full example see the \helpref{XTI overview}{runtimeclassoverview}.


\membersection{wxFLAGS\_MEMBER}\label{wxflagsmember}

\func{}{wxFLAGS\_MEMBER}{value}

Declares a flag value named \tt{value}.


\membersection{wxEND\_FLAGS}\label{wxendflags}

\func{}{wxEND\_FLAGS}{flagsName}
...
\membersection{wxBEGIN\_EVENT\_TABLE}\label{wxbegineventtable}

\func{}{wxBEGIN\_EVENT\_TABLE}{className, baseClassName}
...
\helpref{event handling overview}{eventhandlingoverview}), use the
\helpref{wxEND\_EVENT\_TABLE}{wxendeventstable} macro 
to mark the end of the table.


\membersection{wxEND\_EVENT\_TABLE}\label{wxendeventtable}

\func{}{wxEND\_EVENT\_TABLE}{}

Marks the end of the table of registered event handlers for some class.
See \helpref{wxBEGIN\_EVENT\_TABLE}{wxbegineventtable}.
