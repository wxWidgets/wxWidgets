...
\twocolitem{\windowstyle{wxTR\_LINES\_AT\_ROOT}}{Use this style if you wish lines
to be drawn at the root node (Windows only).}
\end{twocollist}
...
Inserts an item after a given one. To insert an item as the first child, it previous} should be NULL.
