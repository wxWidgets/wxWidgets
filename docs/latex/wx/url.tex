...
But be careful that you don't destroy the URL object while you're getting
the data through the stream. As the protocol and the input stream are
extremely linked together, the destruction of the protocol by URL may
cause you problems.
