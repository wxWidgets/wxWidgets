...
\twocolitem{\helpref{wxHandlerInfo}{wxhandlerinfo}}{Holds information about the a wxObject's handler}
\twocolitem{\helpref{wxPropertyInfo}{wxpropertyinfo}}{Holds information about a wxObject's property}
\twocolitem{\helpref{wxPropertyAccessor}{wxpropertyaccessor}}{Allows to retrieve and set a wxPropertyInfo}
\twocolitem{\helpref{wxTypeInfo}{wxtypeinfo}}{Holds information about a type}
\twocolitem{\helpref{wxObject}{wxobject}}{Root class for classes with run-time information}
\twocolitem{\helpref{XTI macros}{rttimacros}}{Macros for manipulating run-time information}
\end{twocollist}
...
\twocolwidtha{6cm}
\begin{twocollist}\itemsep=0pt
\twocolitem{\helpref{FIXME}{FIXME}}{FIXME}
\end{twocollist}
