...
@beginDefList
@itemdef{ <tt>msw</tt>, Windows, preferred platform name }
@itemdef{ <tt>win</tt>, Windows, alternative synonym }
@itemdef{ <tt>mac</tt>, macOS or iOS }
@itemdef{ <tt>unix</tt>, Any Unix platform @em except macOS }
@endDefList
