...
The option `wxBUILD_INSTALL_LIBRARY_DIR` is used to specify the name of the library directory relative to
`CMAKE_INSTALL_PREFIX`. For example on Linux it might be used as `-DwxBUILD_INSTALL_LIBRARY_DIR=lib64`.
