...
////@begin wxRichTextFontPage member variables
    ...
    enum {
        ...
        ID_RICHTEXTFONTPAGE_SIZETEXTCTRL = 10003,
        ID_RICHTEXTFONTPAGE_SIZELISTBOX = 10004,
        ID_RICHTEXTFONTPAGE_STYLECTRL = 10005,
        ID_RICHTEXTFONTPAGE_WEIGHTCTRL = 10006,
        ID_RICHTEXTFONTPAGE_UNDERLINING_CTRL = 10007,
        ID_RICHTEXTFONTPAGE_COLOURCTRL_LABEL = 10008,
        ID_RICHTEXTFONTPAGE_COLOURCTRL = 10009,
        ID_RICHTEXTFONTPAGE_BGCOLOURCTRL_LABEL = 10010,
        ID_RICHTEXTFONTPAGE_BGCOLOURCTRL = 10011,
        ID_RICHTEXTFONTPAGE_STRIKETHROUGHCTRL = 10012,
        ID_RICHTEXTFONTPAGE_CAPSCTRL = 10013,
        ID_RICHTEXTFONTPAGE_SMALLCAPSCTRL = 10014,
        ID_RICHTEXTFONTPAGE_SUPERSCRIPT = 10015,
        ID_RICHTEXTFONTPAGE_SUBSCRIPT = 10016,
        ID_RICHTEXTFONTPAGE_PREVIEWCTRL = 10017
    };
