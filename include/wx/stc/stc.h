...
BEGIN_DECLARE_EVENT_TYPES()
    DECLARE_EXPORTED_EVENT_TYPE(wxEVT_STC_CHANGE,                  1650)
    DECLARE_EXPORTED_EVENT_TYPE(wxEVT_STC_STYLENEEDED,             1651)
    DECLARE_EXPORTED_EVENT_TYPE(wxEVT_STC_CHARADDED,               1652)
    DECLARE_EXPORTED_EVENT_TYPE(wxEVT_STC_SAVEPOINTREACHED,        1653)
    DECLARE_EXPORTED_EVENT_TYPE(wxEVT_STC_SAVEPOINTLEFT,           1654)
    DECLARE_EXPORTED_EVENT_TYPE(wxEVT_STC_ROMODIFYATTEMPT,         1655)
    DECLARE_EXPORTED_EVENT_TYPE(wxEVT_STC_KEY,                     1656)
    DECLARE_EXPORTED_EVENT_TYPE(wxEVT_STC_DOUBLECLICK,             1657)
    DECLARE_EXPORTED_EVENT_TYPE(wxEVT_STC_UPDATEUI,                1658)
    DECLARE_EXPORTED_EVENT_TYPE(wxEVT_STC_MODIFIED,                1659)
    DECLARE_EXPORTED_EVENT_TYPE(wxEVT_STC_MACRORECORD,             1660)
    DECLARE_EXPORTED_EVENT_TYPE(wxEVT_STC_MARGINCLICK,             1661)
    DECLARE_EXPORTED_EVENT_TYPE(wxEVT_STC_NEEDSHOWN,               1662)
    DECLARE_EXPORTED_EVENT_TYPE(wxEVT_STC_POSCHANGED,              1663)
    DECLARE_EXPORTED_EVENT_TYPE(wxEVT_STC_PAINTED,                 1664)
    DECLARE_EXPORTED_EVENT_TYPE(wxEVT_STC_USERLISTSELECTION,       1665)
    DECLARE_EXPORTED_EVENT_TYPE(wxEVT_STC_URIDROPPED,              1666)
    DECLARE_EXPORTED_EVENT_TYPE(wxEVT_STC_DWELLSTART,              1667)
    DECLARE_EXPORTED_EVENT_TYPE(wxEVT_STC_DWELLEND,                1668)
    DECLARE_EXPORTED_EVENT_TYPE(wxEVT_STC_START_DRAG,              1669)
    DECLARE_EXPORTED_EVENT_TYPE(wxEVT_STC_DRAG_OVER,               1670)
    DECLARE_EXPORTED_EVENT_TYPE(wxEVT_STC_DO_DROP,                 1671)
    DECLARE_EXPORTED_EVENT_TYPE(wxEVT_STC_ZOOM,                    1672)
    DECLARE_EXPORTED_EVENT_TYPE(wxEVT_STC_HOTSPOT_CLICK,           1673)
    DECLARE_EXPORTED_EVENT_TYPE(wxEVT_STC_HOTSPOT_DCLICK,          1674)
    DECLARE_EXPORTED_EVENT_TYPE(wxEVT_STC_CALLTIP_CLICK,           1675)
