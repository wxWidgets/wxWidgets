...
public:
    ...
    struct GeometryInfo
    {
        ...
        void ExtendWidth(wxCoord w)
        {
            ...
            m_rectAll.width = w;
            m_rectLabel.x = m_rectLabel.x + (w - m_rectLabel.width) / 2;
            m_rectIcon.x = m_rectIcon.x + (w - m_rectIcon.width) / 2;
            m_rectHighlight.x = m_rectHighlight.x + (w - m_rectHighlight.width) / 2;
        }
    }
    *m_gi;
