...
public:
    ...
    wxBitmap GetBitmapNormal() const { return wxBitmapBundle::GetBitmapFor(m_bmpNormal, this); }
    wxBitmap GetBitmapPressed() const { return wxBitmapBundle::GetBitmapFor(m_bmpPressed, this); }
    wxBitmap GetBitmapHover() const { return wxBitmapBundle::GetBitmapFor(m_bmpHover, this); }
    wxBitmap GetBitmapDisabled() const { return wxBitmapBundle::GetBitmapFor(m_bmpDisabled, this); }
