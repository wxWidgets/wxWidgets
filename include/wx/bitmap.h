...
{
    public:
        wxBitmapHandler() { m_name = ""; m_extension = ""; m_type = wxBITMAP_TYPE_INVALID; }
        ...
        inline void SetType(wxBitmapType type) { m_type = type; }
        inline wxString GetName() const { return m_name; }
        inline wxString GetExtension() const { return m_extension; }
        inline wxBitmapType GetType() const { return m_type; }
