...
__CRT_UUID_DECL(ICoreWebView2_22, 0x39A89B59, 0x826D, 0x4E09, 0xA6, 0x6B, 0x79, 0x76, 0xB2, 0x98, 0xE4, 0x6F);
...
public:
    ...
    void AddWebResourceRequestedFilter(const wxString& filterURI);
