...
enum wxAuiNotebookOption
{
    ...
    wxAUI_NB_LEFT                = wxAUI_MGR_NB_LEFT,  // not implemented yet
    wxAUI_NB_RIGHT               = wxAUI_MGR_NB_RIGHT,  // not implemented yet
    wxAUI_NB_BOTTOM              = wxAUI_MGR_NB_BOTTOM,
    wxAUI_NB_TAB_SPLIT           = wxAUI_MGR_NB_TAB_SPLIT,
    wxAUI_NB_TAB_MOVE            = wxAUI_MGR_NB_TAB_MOVE,
    wxAUI_NB_TAB_EXTERNAL_MOVE   = wxAUI_MGR_NB_TAB_EXTERNAL_MOVE,
