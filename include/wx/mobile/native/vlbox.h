...
#ifndef _WX_MOBILE_NATIVE_VLBOX_H_
#define _WX_MOBILE_NATIVE_VLBOX_H_

#include "wx/mobile/native/vscroll.h"

class WXDLLIMPEXP_FWD_CORE wxSelectionStore;

#define wxMoVListBoxNameStr _T("wxMoVListBox")
 ...
 */
class WXDLLEXPORT wxMoVListBox : public wxMoVScrolledWindow
{
public:
...
protected:
    ...
    // JACS: draw overall background
    virtual void DrawBackground(wxDC& WXUNUSED(dc)) {}
...
private:
    ...
    DECLARE_EVENT_TABLE()
    DECLARE_NO_COPY_CLASS(wxMoVListBox)
    DECLARE_ABSTRACT_CLASS(wxMoVListBox)
};


#endif
    // _WX_MOBILE_NATIVE_VLBOX_H_
