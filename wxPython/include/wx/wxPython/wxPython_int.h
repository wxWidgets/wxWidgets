...
typedef swig_type_info* (*p_SWIG_TypeRegister_t)(swig_type_info *);
typedef swig_type_info* (*p_SWIG_TypeCheck_t)(char *c, swig_type_info *);
typedef void*           (*p_SWIG_TypeCast_t)(swig_type_info *, void *);
typedef swig_type_info* (*p_SWIG_TypeDynamicCast_t)(swig_type_info *, void **);
typedef const char*     (*p_SWIG_TypeName_t)(const swig_type_info *);
typedef swig_type_info* (*p_SWIG_TypeQuery_t)(const char *);
typedef void            (*p_SWIG_TypeClientData_t)(swig_type_info *, void *);
typedef PyObject*       (*p_SWIG_newvarlink_t)(void);
typedef void            (*p_SWIG_addvarlink_t)(PyObject *, char *, PyObject *(*)(void), int (*)(PyObject *));
typedef int             (*p_SWIG_ConvertPtr_t)(PyObject *, void **, swig_type_info *, int);
typedef int             (*p_SWIG_ConvertPacked_t)(PyObject *, void *, int sz, swig_type_info *, int);
typedef char*           (*p_SWIG_PackData_t)(char *c, void *, int);
typedef char*           (*p_SWIG_UnpackData_t)(char *c, void *, int);
typedef PyObject*       (*p_SWIG_NewPointerObj_t)(void *, swig_type_info *,int own);
typedef PyObject*       (*p_SWIG_NewPackedObj_t)(void *, int sz, swig_type_info *);
typedef void            (*p_SWIG_InstallConstants_t)(PyObject *d, swig_const_info constants[]);


struct wxPyCoreAPI {

    p_SWIG_TypeRegister_t       p_SWIG_TypeRegister;
    p_SWIG_TypeCheck_t          p_SWIG_TypeCheck;
    p_SWIG_TypeCast_t           p_SWIG_TypeCast;
    p_SWIG_TypeDynamicCast_t    p_SWIG_TypeDynamicCast;
    p_SWIG_TypeName_t           p_SWIG_TypeName;
    p_SWIG_TypeQuery_t          p_SWIG_TypeQuery;
    p_SWIG_TypeClientData_t     p_SWIG_TypeClientData;
    p_SWIG_newvarlink_t         p_SWIG_newvarlink;
    p_SWIG_addvarlink_t         p_SWIG_addvarlink;
    p_SWIG_ConvertPtr_t         p_SWIG_ConvertPtr;
    p_SWIG_ConvertPacked_t      p_SWIG_ConvertPacked;
    p_SWIG_PackData_t           p_SWIG_PackData;
    p_SWIG_UnpackData_t         p_SWIG_UnpackData;
    p_SWIG_NewPointerObj_t      p_SWIG_NewPointerObj;
    p_SWIG_NewPackedObj_t       p_SWIG_NewPackedObj;
    p_SWIG_InstallConstants_t   p_SWIG_InstallConstants;
