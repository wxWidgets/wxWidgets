...
wxHelpEventPtr = wxPython.wx.wxHelpEventPtr
wxHelpEvent = wxPython.wx.wxHelpEvent
wxContextHelpPtr = wxPython.wx.wxContextHelpPtr
wxContextHelp = wxPython.wx.wxContextHelp
wxContextHelpButtonPtr = wxPython.wx.wxContextHelpButtonPtr
wxContextHelpButton = wxPython.wx.wxContextHelpButton
wxHelpProviderPtr = wxPython.wx.wxHelpProviderPtr
wxHelpProvider = wxPython.wx.wxHelpProvider
wxSimpleHelpProviderPtr = wxPython.wx.wxSimpleHelpProviderPtr
