...
set MAINCMDLINE=SHARED=1 MONOLITHIC=0 USE_WEBVIEW=1 CXXFLAGS="-fno-keep-inline-dllexport" OFFICIAL_BUILD=1 COMPILER_VERSION=%COMPVERS%
if "%2" == "64" (
...
:ERR_NOPARM
   ...
   echo officialbuildgcc.bat cmpVers Archi
   echo cmpVers = Compiler version (730, 810, 920, ...)
   echo Archi   = architecture (32 or 64)
