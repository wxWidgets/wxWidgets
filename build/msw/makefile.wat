...
$(OBJS)\wxzlib_infblock.obj :  .AUTODEPEND ..\..\src\zlib\infblock.c
	$(CC) -zq -fo=$^@ $(WXZLIB_CFLAGS) $<

$(OBJS)\wxzlib_inftrees.obj :  .AUTODEPEND ..\..\src\zlib\inftrees.c
	$(CC) -zq -fo=$^@ $(WXZLIB_CFLAGS) $<

$(OBJS)\wxzlib_infcodes.obj :  .AUTODEPEND ..\..\src\zlib\infcodes.c
	$(CC) -zq -fo=$^@ $(WXZLIB_CFLAGS) $<

$(OBJS)\wxzlib_infutil.obj :  .AUTODEPEND ..\..\src\zlib\infutil.c
	$(CC) -zq -fo=$^@ $(WXZLIB_CFLAGS) $<
