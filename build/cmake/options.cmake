...
set(wxBUILD_INSTALL_RUNTIME_DIR "" CACHE STRING "override default sub-directory to install runtime files")
mark_as_advanced(wxBUILD_INSTALL_RUNTIME_DIR)
set(wxBUILD_INSTALL_LIBRARY_DIR "" CACHE STRING "override default sub-directory to install library files")
...
if(UNIX)
    ...
    wx_option(wxUSE_APPINDICATOR "use AppIndicator (required for wxTaskBarButton under Wayland)")
    ...
    wx_option(wxUSE_WAYLAND "use Wayland-specific code")
...
if(WIN32)
    ...
    if(WXWINUI)
        set(wxUSE_WINUI3_DEFAULT ON)
    else()
        set(wxUSE_WINUI3_DEFAULT OFF)
    endif()
    ...
    wx_option(wxUSE_WINUI3 "enable experimental WinUI 3 support (wxWinUI only)" ${wxUSE_WINUI3_DEFAULT})
