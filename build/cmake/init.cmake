...
if(wxUSE_WINUI3 AND NOT WXWINUI)
    message(WARNING "wxUSE_WINUI3 is only supported with wxBUILD_TOOLKIT=winui... disabled")
    wx_option_force_value(wxUSE_WINUI3 OFF)
endif()
if(WXWINUI)
    if(NOT WIN32)
        message(FATAL_ERROR "wxWinUI is only available on Windows")
    endif()
    if(NOT wxUSE_WINUI3)
        message(FATAL_ERROR
            "wxBUILD_TOOLKIT=winui requires wxUSE_WINUI3=ON; "
            "disabling it would combine WinUI public headers with the MSW "
    ...
    include(build/cmake/winui.cmake)
endif()
