...
if(wxUSE_PEDANTIC_FLAGS)
    ...
    wx_string_append(CMAKE_C_FLAGS   ${PEDANTIC_COMPILER_FLAGS})
    
    if(CMAKE_COMPILER_IS_GNUCC)
        wx_string_append(CMAKE_C_FLAGS   " -Wimplicit-int -Wmissing-prototypes -Werror=implicit-int")
        wx_string_append(CMAKE_CXX_FLAGS " -Werror=delete-non-virtual-dtor -Wclass-memaccess") 
    endif()
endif()
