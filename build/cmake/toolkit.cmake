...
if(WIN32)
    ...
    set(wxTOOLKIT_OPTIONS msw gtk2 gtk3 qt uwp)
...
if(CMAKE_SYSTEM_NAME MATCHES "WindowsStore")
    if(NOT wxBUILD_TOOLKIT MATCHES "uwp")
        message(FATAL_ERROR "UWP: WindowsStore is specified as CMAKE_SYSTEM_NAME, but toolkit is not UWP.")
    endif()
endif()

if(WXUWP)
    if(NOT DEFINED CMAKE_SYSTEM_NAME)
        message(STATUS "UWP: unspecified CMAKE_SYSTEM_NAME, defaulting to WindowsStore")
        set(CMAKE_SYSTEM_NAME WindowsStore)
    endif()
    if(NOT DEFINED CMAKE_SYSTEM_VERSION)
        message(STATUS "UWP: unspecified CMAKE_SYSTEM_VERSION, defaulting to 10.0")
