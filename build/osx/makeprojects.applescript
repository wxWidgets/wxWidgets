...
on parseNode(anElement, theVariables, theConditions)
	if class of anElement is XML element and ￂ
...
init()
set theProject to {projectName:"", conditions:{}, bklfiles:{ￂ
	"../bakefiles/files.bkl", "../bakefiles/zlib.bkl", "../bakefiles/regex.bkl", "../bakefiles/tiff.bkl", "../bakefiles/png.bkl", "../bakefiles/jpeg.bkl", "../bakefiles/scintilla.bkl", "../bakefiles/expat.bkl"}, nodes:{ￂ
	{label:"base", entries:{"$(BASE_SRC)"}}, ￂ
	{label:"base", entries:{"$(BASE_AND_GUI_SRC)"}}, ￂ
	{label:"core", entries:{"$(CORE_SRC)"}}, ￂ
	{label:"net", entries:{"$(NET_SRC)"}}, ￂ
	{label:"adv", entries:{"$(ADVANCED_SRC)"}}, ￂ
	{label:"webview", entries:{"$(WEBVIEW_SRC)"}}, ￂ
	{label:"media", entries:{"$(MEDIA_SRC)"}}, ￂ
	{label:"html", entries:{"$(HTML_SRC)"}}, ￂ
	{label:"xrc", entries:{"$(XRC_SRC)"}}, ￂ
	{label:"xml", entries:{"$(XML_SRC)"}}, ￂ
	{label:"opengl", entries:{"$(OPENGL_SRC)"}}, ￂ
	{label:"aui", entries:{"$(AUI_SRC)"}}, ￂ
	{label:"ribbon", entries:{"$(RIBBON_SRC)"}}, ￂ
	{label:"propgrid", entries:{"$(PROPGRID_SRC)"}}, ￂ
	{label:"richtext", entries:{"$(RICHTEXT_SRC)"}}, ￂ
	{label:"stc", entries:{"$(STC_SRC)"}}, ￂ
	{label:"libzlib", entries:{"$(wxzlib)"}}, ￂ
	{label:"libtiff", entries:{"$(wxtiff)"}}, ￂ
	{label:"libjpeg", entries:{"$(wxjpeg)"}}, ￂ
	{label:"libpng", entries:{"$(wxpng)"}}, ￂ
	{label:"libregex", entries:{"$(wxregex)"}}, ￂ
	{label:"libscintilla", entries:{"$(wxscintilla)"}}, ￂ
	{label:"libexpat", entries:{"$(wxexpat)"}} ￂ
		}}
