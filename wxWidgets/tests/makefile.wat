...
$(OBJS)\test.exe :  $(TEST_OBJECTS)
	...
	@%append $(OBJS)\test.lbc $(LDFLAGS) $(__DEBUGINFO_2)  libpath $(LIBDIRNAME) system os2v2 $(CPPUNIT_LIBS)
...
$(OBJS)\test_gui.exe :  $(TEST_GUI_OBJECTS)
	...
	@%append $(OBJS)\test_gui.lbc $(LDFLAGS) $(__DEBUGINFO_2)  libpath $(LIBDIRNAME) $(CPPUNIT_LIBS) system os2v2
...
$(OBJS)\printfbench.exe :  $(PRINTFBENCH_OBJECTS)
	...
	@%append $(OBJS)\printfbench.lbc $(LDFLAGS) $(__DEBUGINFO_2)  libpath $(LIBDIRNAME) system os2v2 $(CPPUNIT_LIBS)
