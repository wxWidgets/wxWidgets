...
$(OBJS)\tex2rtf.exe :  $(TEX2RTF_OBJECTS)
	...
	@%append $(OBJS)\tex2rtf.lbc $(LDFLAGS) $(__DEBUGINFO_1)  libpath $(LIBDIRNAME) system os2v2
...
$(OBJS)\tex2rtf_gui.exe :  $(TEX2RTF_GUI_OBJECTS)
	...
	@%append $(OBJS)\tex2rtf_gui.lbc $(LDFLAGS) $(__DEBUGINFO_1)  libpath $(LIBDIRNAME) system os2v2_pm
