...
clean : .SYMBOLIC 
	...
	-del $(OBJS)\helpview.exe

$(OBJS)\helpview.exe :  $(HELPVIEW_OBJECTS)
	...
	@%append $(OBJS)\helpview.lbc $(LDFLAGS) $(__DEBUGINFO_1)  libpath $(LIBDIRNAME) system os2v2_pm
	@for %i in ($(HELPVIEW_OBJECTS)) do @%append $(OBJS)\helpview.lbc file %i
	@for %i in ( $(__WXLIB_HTML_p)  $(__WXLIB_CORE_p)  $(__WXLIB_NET_p)  $(__WXLIB_BASE_p)  $(__WXLIB_MONO_p) $(__LIB_TIFF_p) $(__LIB_JPEG_p) $(__LIB_PNG_p)  wxzlib$(WXDEBUGFLAG).lib  wxregex$(WXUNICODEFLAG)$(WXDEBUGFLAG).lib wxexpat$(WXDEBUGFLAG).lib $(EXTRALIBS_FOR_BASE) upm32.lib) do @%append $(OBJS)\helpview.lbc library %i
	@%append $(OBJS)\helpview.lbc
...
$(OBJS)\helpview_helpview.obj :  .AUTODEPEND .\helpview.cpp
	$(CXX) -bt=os2 -zq -fo=$^@ $(HELPVIEW_CXXFLAGS) $<
