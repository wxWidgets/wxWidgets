...
clean : .SYMBOLIC 
	...
	-del $(OBJS)\wxemulator.exe

$(OBJS)\wxemulator.exe :  $(WXEMULATOR_OBJECTS)
	...
	@%append $(OBJS)\wxemulator.lbc $(LDFLAGS) $(__DEBUGINFO_1)  libpath $(LIBDIRNAME) system os2v2_pm
	@for %i in ($(WXEMULATOR_OBJECTS)) do @%append $(OBJS)\wxemulator.lbc file %i
	@for %i in ( $(__WXLIB_CORE_p)  $(__WXLIB_BASE_p)  $(__WXLIB_MONO_p) $(__LIB_TIFF_p) $(__LIB_JPEG_p) $(__LIB_PNG_p)  wxzlib$(WXDEBUGFLAG).lib  wxregex$(WXUNICODEFLAG)$(WXDEBUGFLAG).lib wxexpat$(WXDEBUGFLAG).lib $(EXTRALIBS_FOR_BASE) upm32.lib) do @%append $(OBJS)\wxemulator.lbc library %i
	@%append $(OBJS)\wxemulator.lbc
...
$(OBJS)\wxemulator_emulator.obj :  .AUTODEPEND .\emulator.cpp
	$(CXX) -bt=os2 -zq -fo=$^@ $(WXEMULATOR_CXXFLAGS) $<
