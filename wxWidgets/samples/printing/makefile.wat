...
clean : .SYMBOLIC 
	...
	-del $(OBJS)\printing.exe

$(OBJS)\printing.exe :  $(PRINTING_OBJECTS)
	...
	@%append $(OBJS)\printing.lbc $(LDFLAGS) $(__DEBUGINFO_1)  libpath $(LIBDIRNAME) system os2v2_pm
	@for %i in ($(PRINTING_OBJECTS)) do @%append $(OBJS)\printing.lbc file %i
	@for %i in ( $(__WXLIB_CORE_p)  $(__WXLIB_BASE_p)  $(__WXLIB_MONO_p) $(__LIB_TIFF_p) $(__LIB_JPEG_p) $(__LIB_PNG_p)  wxzlib$(WXDEBUGFLAG).lib  wxregex$(WXUNICODEFLAG)$(WXDEBUGFLAG).lib wxexpat$(WXDEBUGFLAG).lib $(EXTRALIBS_FOR_BASE) upm32.lib) do @%append $(OBJS)\printing.lbc library %i
	@%append $(OBJS)\printing.lbc
...
$(OBJS)\printing_printing.obj :  .AUTODEPEND .\printing.cpp
	$(CXX) -bt=os2 -zq -fo=$^@ $(PRINTING_CXXFLAGS) $<
