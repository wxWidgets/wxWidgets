...
clean : .SYMBOLIC 
	...
	-del $(OBJS)\virtual.exe

$(OBJS)\virtual.exe :  $(VIRTUAL_OBJECTS)
	...
	@%append $(OBJS)\virtual.lbc $(LDFLAGS) $(__DEBUGINFO_1)  libpath $(LIBDIRNAME) system os2v2_pm
	@for %i in ($(VIRTUAL_OBJECTS)) do @%append $(OBJS)\virtual.lbc file %i
	@for %i in ( $(__WXLIB_HTML_p)  $(__WXLIB_CORE_p)  $(__WXLIB_BASE_p)  $(__WXLIB_MONO_p) $(__LIB_TIFF_p) $(__LIB_JPEG_p) $(__LIB_PNG_p)  wxzlib$(WXDEBUGFLAG).lib  wxregex$(WXUNICODEFLAG)$(WXDEBUGFLAG).lib wxexpat$(WXDEBUGFLAG).lib $(EXTRALIBS_FOR_BASE) upm32.lib) do @%append $(OBJS)\virtual.lbc library %i
	@%append $(OBJS)\virtual.lbc
...
$(OBJS)\virtual_virtual.obj :  .AUTODEPEND .\virtual.cpp
	$(CXX) -bt=os2 -zq -fo=$^@ $(VIRTUAL_CXXFLAGS) $<
