...
$(OBJS)\client.exe :  $(CLIENT_OBJECTS)
	...
	@%append $(OBJS)\client.lbc $(LDFLAGS) $(__DEBUGINFO_1)  libpath $(LIBDIRNAME) system os2v2_pm
...
$(OBJS)\server.exe :  $(SERVER_OBJECTS)
	...
	@%append $(OBJS)\server.lbc $(LDFLAGS) $(__DEBUGINFO_1)  libpath $(LIBDIRNAME) system os2v2_pm
