...
clean : .SYMBOLIC 
	...
	-del $(OBJS)\dataview.exe

$(OBJS)\dataview.exe :  $(DATAVIEW_OBJECTS)
	...
	@%append $(OBJS)\dataview.lbc $(LDFLAGS) $(__DEBUGINFO_1)  libpath $(LIBDIRNAME) system os2v2_pm
	@for %i in ($(DATAVIEW_OBJECTS)) do @%append $(OBJS)\dataview.lbc file %i
	@for %i in ( $(__WXLIB_ADV_p)  $(__WXLIB_CORE_p)  $(__WXLIB_BASE_p)  $(__WXLIB_MONO_p) $(__LIB_TIFF_p) $(__LIB_JPEG_p) $(__LIB_PNG_p)  wxzlib$(WXDEBUGFLAG).lib  wxregex$(WXUNICODEFLAG)$(WXDEBUGFLAG).lib wxexpat$(WXDEBUGFLAG).lib $(EXTRALIBS_FOR_BASE) upm32.lib) do @%append $(OBJS)\dataview.lbc library %i
	@%append $(OBJS)\dataview.lbc
...
$(OBJS)\dataview_dataview.obj :  .AUTODEPEND .\dataview.cpp
	$(CXX) -bt=os2 -zq -fo=$^@ $(DATAVIEW_CXXFLAGS) $<
