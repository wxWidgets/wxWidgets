...
$(OBJS)\splash.exe :  $(SPLASH_OBJECTS)
	...
	@%append $(OBJS)\splash.lbc $(LDFLAGS) $(__DEBUGINFO_1)  libpath $(LIBDIRNAME) system os2v2_pm
	@for %i in ($(SPLASH_OBJECTS)) do @%append $(OBJS)\splash.lbc file %i
	@for %i in ( $(__WXLIB_MEDIA_p)  $(__WXLIB_ADV_p)  $(__WXLIB_HTML_p)  $(__WXLIB_XML_p)  $(__WXLIB_CORE_p)  $(__WXLIB_BASE_p)  $(__WXLIB_MONO_p) $(__LIB_TIFF_p) $(__LIB_JPEG_p) $(__LIB_PNG_p)  wxzlib$(WXDEBUGFLAG).lib  wxregex$(WXUNICODEFLAG)$(WXDEBUGFLAG).lib wxexpat$(WXDEBUGFLAG).lib $(EXTRALIBS_FOR_BASE) upm32.lib) do @%append $(OBJS)\splash.lbc library %i
	@%append $(OBJS)\splash.lbc
...
$(OBJS)\splash_splash.obj :  .AUTODEPEND .\splash.cpp
	$(CXX) -bt=os2 -zq -fo=$^@ $(SPLASH_CXXFLAGS) $<
