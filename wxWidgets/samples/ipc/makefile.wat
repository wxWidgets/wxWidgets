...
$(OBJS)\ipcclient.exe :  $(IPCCLIENT_OBJECTS)
	...
	@%append $(OBJS)\ipcclient.lbc $(LDFLAGS) $(__DEBUGINFO_1)  libpath $(LIBDIRNAME) system os2v2_pm
...
$(OBJS)\ipcserver.exe :  $(IPCSERVER_OBJECTS)
	...
	@%append $(OBJS)\ipcserver.lbc $(LDFLAGS) $(__DEBUGINFO_1)  libpath $(LIBDIRNAME) system os2v2_pm
