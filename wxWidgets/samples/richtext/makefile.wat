...
clean : .SYMBOLIC 
	...
	-del $(OBJS)\richtext.exe

$(OBJS)\richtext.exe :  $(RICHTEXT_OBJECTS)
	...
	@%append $(OBJS)\richtext.lbc $(LDFLAGS) $(__DEBUGINFO_1)  libpath $(LIBDIRNAME) system os2v2_pm
	@for %i in ($(RICHTEXT_OBJECTS)) do @%append $(OBJS)\richtext.lbc file %i
	@for %i in ( $(__WXLIB_RICHTEXT_p)  $(__WXLIB_ADV_p)  $(__WXLIB_HTML_p)  $(__WXLIB_CORE_p)  $(__WXLIB_XML_p)  $(__WXLIB_BASE_p)  $(__WXLIB_MONO_p) $(__LIB_TIFF_p) $(__LIB_JPEG_p) $(__LIB_PNG_p)  wxzlib$(WXDEBUGFLAG).lib  wxregex$(WXUNICODEFLAG)$(WXDEBUGFLAG).lib wxexpat$(WXDEBUGFLAG).lib $(EXTRALIBS_FOR_BASE) upm32.lib) do @%append $(OBJS)\richtext.lbc library %i
	@%append $(OBJS)\richtext.lbc
...
$(OBJS)\richtext_richtext.obj :  .AUTODEPEND .\richtext.cpp
	$(CXX) -bt=os2 -zq -fo=$^@ $(RICHTEXT_CXXFLAGS) $<
