...
clean : .SYMBOLIC 
	...
	-del $(OBJS)\convertrc.exe

$(OBJS)\convertrc.exe :  $(CONVERTRC_OBJECTS)
...
$(OBJS)\convertrc_convert.obj :  .AUTODEPEND .\convert.cpp
	$(CXX) -bt=os2 -zq -fo=$^@ $(CONVERTRC_CXXFLAGS) $<
