...
clean : .SYMBOLIC 
	...
	-del $(OBJS)\stctest.exe

$(OBJS)\stctest.exe :  $(STCTEST_OBJECTS)
...
$(OBJS)\stctest_stctest.obj :  .AUTODEPEND .\stctest.cpp
	$(CXX) -bt=os2 -zq -fo=$^@ $(STCTEST_CXXFLAGS) $<
