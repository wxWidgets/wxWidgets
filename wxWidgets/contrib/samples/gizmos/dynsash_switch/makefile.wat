...
clean : .SYMBOLIC 
	...
	-del $(OBJS)\dynsash_switch.exe

$(OBJS)\dynsash_switch.exe :  $(DYNSASH_SWITCH_OBJECTS)
...
$(OBJS)\dynsash_switch_dynsash_switch.obj :  .AUTODEPEND .\dynsash_switch.cpp
	$(CXX) -bt=os2 -zq -fo=$^@ $(DYNSASH_SWITCH_CXXFLAGS) $<
