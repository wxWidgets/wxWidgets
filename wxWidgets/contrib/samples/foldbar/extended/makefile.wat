...
clean : .SYMBOLIC 
	...
	-del $(OBJS)\extended.exe

$(OBJS)\extended.exe :  $(EXTENDED_OBJECTS)
...
$(OBJS)\extended_extended.obj :  .AUTODEPEND .\extended.cpp
	$(CXX) -bt=os2 -zq -fo=$^@ $(EXTENDED_CXXFLAGS) $<
