...
dnl ### begin block COND_TOOLKIT_COCOA_USE_GUI_1 ###
...
dnl ### begin block COND_OFFICIAL_BUILD_0 ###
    COND_OFFICIAL_BUILD_0="#"
    if test "x$OFFICIAL_BUILD" = "x0" ; then
        COND_OFFICIAL_BUILD_0=""
    fi
    AC_SUBST(COND_OFFICIAL_BUILD_0)
...
dnl ### begin block COND_OFFICIAL_BUILD_1 ###
    COND_OFFICIAL_BUILD_1="#"
    if test "x$OFFICIAL_BUILD" = "x1" ; then
        COND_OFFICIAL_BUILD_1=""
    fi
    AC_SUBST(COND_OFFICIAL_BUILD_1)
