...
PREFERENCES_CXXFLAGS = $(__DEBUGINFO_0) $(__OPTIMIZEFLAG_2) $(__THREADSFLAG_5) &
...
PREFERENCES_OBJECTS =  &
	$(OBJS)\preferences_preferences.obj
...
all : .SYMBOLIC $(OBJS)\preferences.exe
...
clean : .SYMBOLIC 
	...
	-if exist $(OBJS)\preferences.exe del $(OBJS)\preferences.exe

$(OBJS)\preferences.exe :  $(PREFERENCES_OBJECTS) $(OBJS)\preferences_sample.res
	@%create $(OBJS)\preferences.lbc
	@%append $(OBJS)\preferences.lbc option quiet
	@%append $(OBJS)\preferences.lbc name $^@
	@%append $(OBJS)\preferences.lbc option caseexact
	@%append $(OBJS)\preferences.lbc  $(__DEBUGINFO_1)  libpath $(LIBDIRNAME) system nt_win ref '_WinMain@16' $(____CAIRO_LIBDIR_FILENAMES_p) $(LDFLAGS)
	@for %i in ($(PREFERENCES_OBJECTS)) do @%append $(OBJS)\preferences.lbc file %i
	@for %i in ( $(__WXLIB_CORE_p)  $(__WXLIB_BASE_p)  $(__WXLIB_MONO_p) $(__LIB_SCINTILLA_IF_MONO_p) $(__LIB_TIFF_p) $(__LIB_JPEG_p) $(__LIB_PNG_p)   wxzlib$(WXDEBUGFLAG).lib wxregex$(WXUNICODEFLAG)$(WXDEBUGFLAG).lib wxexpat$(WXDEBUGFLAG).lib $(EXTRALIBS_FOR_BASE)  $(__CAIRO_LIB_p) kernel32.lib user32.lib gdi32.lib comdlg32.lib winspool.lib winmm.lib shell32.lib comctl32.lib ole32.lib oleaut32.lib uuid.lib rpcrt4.lib advapi32.lib wsock32.lib wininet.lib) do @%append $(OBJS)\preferences.lbc library %i
	@%append $(OBJS)\preferences.lbc option resource=$(OBJS)\preferences_sample.res
	@for %i in () do @%append $(OBJS)\preferences.lbc option stack=%i
	wlink @$(OBJS)\preferences.lbc

$(OBJS)\preferences_sample.res :  .AUTODEPEND .\..\..\samples\sample.rc
...
$(OBJS)\preferences_preferences.obj :  .AUTODEPEND .\preferences.cpp
	$(CXX) -bt=nt -zq -fo=$^@ $(PREFERENCES_CXXFLAGS) $<
