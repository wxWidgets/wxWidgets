...
enum wxFontEncoding
{
    ...
    */
    ...
    wxFONTENCODING_CP1250,          //!< Central European; Central European (Windows)
    wxFONTENCODING_CP1251,          //!< Cyrillic; Cyrillic (Windows)
    wxFONTENCODING_CP1252,          //!< Latin 1; Western European (Windows)
    wxFONTENCODING_CP1253,          //!< Greek; Greek (Windows) (8859-7)
    wxFONTENCODING_CP1254,          //!< Turkish; Turkish (Windows)
    wxFONTENCODING_CP1255,          //!< Hebrew; Hebrew (Windows)
    wxFONTENCODING_CP1256,          //!< Arabic; Arabic (Windows)
    wxFONTENCODING_CP1257,          //!< Baltic; Baltic (Windows) (same as Latin 7)
    wxFONTENCODING_CP1258,          //!< Vietnamese; Vietnamese (Windows) (since 2.9.4)
