...
enum wxImageResizeQuality
{
    ...
    */
    ...
    /**
        ...
        Currently this algorithm uses wxIMAGE_QUALITY_BILINEAR with an integer
        factor when reducing the image size (in both directions) and, either
        after doing this, or as the only step when enlarging the image, applies
        wxIMAGE_QUALITY_BOX_AVERAGE to obtain the desired size.
