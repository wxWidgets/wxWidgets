...
public:
    ...
    */
    ...
    /**
        ...
        For good reasons, the event object is not set to the window generating
        the event, but to the validator itself, to make it possible for users
        to handle this event before the validator takes over it by itself.

        @see "How Events are Processed" @ref overview_events.
    */
