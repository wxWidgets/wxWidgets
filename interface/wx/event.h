...
/**
    ...
    MSW application runs under Windows 10 v1607 or later and is marked as being
    "per-monitor DPI aware", i.e. contains a @c dpiAwareness tag with the value
    "PerMonitorV2" in its manifest (see Microsoft
