...
/**
    ...
    A DPI-changed event is sent when the dots-per-inch (DPI) of the monitor
    a wxTopLevelWindow is on changes.
    The event is send to the wxTopLevelWindow, and all its children.

    The event is only generated when the application is Per-Monitor DPI-Aware,
    and is currently only generated by wxMSW port.
