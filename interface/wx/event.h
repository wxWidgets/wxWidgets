...
/** @class wxTouchEventBase
    This is the base class for all touch events.
    ...
    @see wxGestureEvent, wxMultiTouchEvent

    @since 3.1.1
*/
class wxTouchEventBase : public wxEvent
{
    /**
        Constructor.
    */
...
/** @class wxGestureEvent
    ...
    @since 3.1.1
*/
class wxGestureEvent : public wxTouchEventBase
{
public:
    /**
        Constructor.
