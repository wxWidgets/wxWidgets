...
enum
{
    /// Under GTK, forces the use of the generic version of the control,
    /// regardless of with version of GTK is available. This is useful
    /// for using generic version only features such as ShowCheckBox().
    wxINFOBAR_GENERIC = 0x0080
};
...
public:
    ...
    /**
        ...
        @param style
            The style for the control. wxINFOBAR_GENERIC will force the control
            to use the generic implementation under GTK.
     */
