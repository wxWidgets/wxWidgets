...
SPLITTREE_CXXFLAGS = $(CPPFLAGS) $(__DEBUGINFO_0) $(__OPTIMIZEFLAG_2) -bm &
...
$(OBJS)\splittree.exe :  $(SPLITTREE_OBJECTS) $(OBJS)\splittree_sample.res
	...
	@%append $(OBJS)\splittree.lbc option incremental
