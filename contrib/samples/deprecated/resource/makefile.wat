...
clean : .SYMBOLIC 
	...
	-del $(OBJS)\resource.exe

$(OBJS)\resource.exe :  $(RESOURCE_OBJECTS)
...
$(OBJS)\resource_resource.obj :  .AUTODEPEND .\resource.cpp
	$(CXX) -bt=os2 -zq -fo=$^@ $(RESOURCE_CXXFLAGS) $<
