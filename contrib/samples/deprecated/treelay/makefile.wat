...
TREELAY_CXXFLAGS = $(__DEBUGINFO_0) $(__OPTIMIZEFLAG_2) -bm $(__RUNTIME_LIBS_5) &
	-d__WXMSW__ $(__WXUNIV_DEFINE_p) $(__DEBUG_DEFINE_p) $(__UNICODE_DEFINE_p) &
	-i=.\..\..\..\..\include -i=$(SETUPHDIR) -wx -wcd=549 -wcd=656 -wcd=657 &
	-wcd=667 -i=. $(__DLLFLAG_p) -i=.\..\..\..\..\samples -dNOPCH &
	-i=.\..\..\..\include $(__EXCEPTIONSFLAG_6) $(__EXCEPTIONSFLAG_7) &
	$(CPPFLAGS) $(CXXFLAGS)
TREELAY_OBJECTS =  &
...
$(OBJS)\treelay_treelay.res :  .AUTODEPEND .\treelay.rc
	wrc -q -ad -bt=nt -r -fo=$^@   -d__WXMSW__ $(__WXUNIV_DEFINE_p) $(__DEBUG_DEFINE_p) $(__UNICODE_DEFINE_p) -i=.\..\..\..\..\include -i=$(SETUPHDIR) -i=. $(__DLLFLAG_p) -i=.\..\..\..\..\samples -dNOPCH -i=.\..\..\..\include $<
