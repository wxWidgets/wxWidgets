...
clean : .SYMBOLIC 
	...
	-del $(OBJS)\proplist.exe

$(OBJS)\proplist.exe :  $(PROPLIST_OBJECTS)
...
$(OBJS)\proplist_proplist.obj :  .AUTODEPEND .\proplist.cpp
	$(CXX) -bt=os2 -zq -fo=$^@ $(PROPLIST_CXXFLAGS) $<
