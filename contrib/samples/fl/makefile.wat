...
clean : .SYMBOLIC 
	...
	-del $(OBJS)\fl_demo1.exe
	-del $(OBJS)\fl_demo2.exe
	-del $(OBJS)\fl_sample1.exe
	-del $(OBJS)\fl_sample2.exe
	-del $(OBJS)\fl_sample3.exe

$(OBJS)\fl_demo1.exe :  $(FL_DEMO1_OBJECTS)
...
$(OBJS)\fl_demo2.exe :  $(FL_DEMO2_OBJECTS)
	...
	@%append $(OBJS)\fl_demo2.lbc  $(__DEBUGINFO_4)  libpath $(LIBDIRNAME) system os2v2_pm $(LDFLAGS)
	@for %i in ($(FL_DEMO2_OBJECTS)) do @%append $(OBJS)\fl_demo2.lbc file %i
	@for %i in ( wx$(PORTNAME)$(WXUNIVNAME)$(WX_RELEASE_NODOT)$(WXUNICODEFLAG)$(WXDEBUGFLAG)$(WX_LIB_FLAVOUR)_fl.lib  $(__WXLIB_CORE_p)  $(__WXLIB_BASE_p)  $(__WXLIB_MONO_p) $(__LIB_TIFF_p) $(__LIB_JPEG_p) $(__LIB_PNG_p)  wxzlib$(WXDEBUGFLAG).lib  wxregex$(WXUNICODEFLAG)$(WXDEBUGFLAG).lib wxexpat$(WXDEBUGFLAG).lib $(EXTRALIBS_FOR_BASE) upm32.lib) do @%append $(OBJS)\fl_demo2.lbc library %i
	@%append $(OBJS)\fl_demo2.lbc
	@for %i in () do @%append $(OBJS)\fl_demo2.lbc option stack=%i
	wlink @$(OBJS)\fl_demo2.lbc

$(OBJS)\fl_sample1.exe :  $(FL_SAMPLE1_OBJECTS)
	...
	@%append $(OBJS)\fl_sample1.lbc  $(__DEBUGINFO_4)  libpath $(LIBDIRNAME) system os2v2_pm $(LDFLAGS)
	@for %i in ($(FL_SAMPLE1_OBJECTS)) do @%append $(OBJS)\fl_sample1.lbc file %i
	@for %i in ( wx$(PORTNAME)$(WXUNIVNAME)$(WX_RELEASE_NODOT)$(WXUNICODEFLAG)$(WXDEBUGFLAG)$(WX_LIB_FLAVOUR)_fl.lib  $(__WXLIB_CORE_p)  $(__WXLIB_BASE_p)  $(__WXLIB_MONO_p) $(__LIB_TIFF_p) $(__LIB_JPEG_p) $(__LIB_PNG_p)  wxzlib$(WXDEBUGFLAG).lib  wxregex$(WXUNICODEFLAG)$(WXDEBUGFLAG).lib wxexpat$(WXDEBUGFLAG).lib $(EXTRALIBS_FOR_BASE) upm32.lib) do @%append $(OBJS)\fl_sample1.lbc library %i
	@%append $(OBJS)\fl_sample1.lbc
	@for %i in () do @%append $(OBJS)\fl_sample1.lbc option stack=%i
	wlink @$(OBJS)\fl_sample1.lbc

$(OBJS)\fl_sample2.exe :  $(FL_SAMPLE2_OBJECTS)
	...
	@%append $(OBJS)\fl_sample2.lbc  $(__DEBUGINFO_4)  libpath $(LIBDIRNAME) system os2v2_pm $(LDFLAGS)
	@for %i in ($(FL_SAMPLE2_OBJECTS)) do @%append $(OBJS)\fl_sample2.lbc file %i
	@for %i in ( wx$(PORTNAME)$(WXUNIVNAME)$(WX_RELEASE_NODOT)$(WXUNICODEFLAG)$(WXDEBUGFLAG)$(WX_LIB_FLAVOUR)_fl.lib  $(__WXLIB_CORE_p)  $(__WXLIB_BASE_p)  $(__WXLIB_MONO_p) $(__LIB_TIFF_p) $(__LIB_JPEG_p) $(__LIB_PNG_p)  wxzlib$(WXDEBUGFLAG).lib  wxregex$(WXUNICODEFLAG)$(WXDEBUGFLAG).lib wxexpat$(WXDEBUGFLAG).lib $(EXTRALIBS_FOR_BASE) upm32.lib) do @%append $(OBJS)\fl_sample2.lbc library %i
	@%append $(OBJS)\fl_sample2.lbc
	@for %i in () do @%append $(OBJS)\fl_sample2.lbc option stack=%i
	wlink @$(OBJS)\fl_sample2.lbc

$(OBJS)\fl_sample3.exe :  $(FL_SAMPLE3_OBJECTS)
	...
	@%append $(OBJS)\fl_sample3.lbc  $(__DEBUGINFO_4)  libpath $(LIBDIRNAME) system os2v2_pm $(LDFLAGS)
	@for %i in ($(FL_SAMPLE3_OBJECTS)) do @%append $(OBJS)\fl_sample3.lbc file %i
	@for %i in ( wx$(PORTNAME)$(WXUNIVNAME)$(WX_RELEASE_NODOT)$(WXUNICODEFLAG)$(WXDEBUGFLAG)$(WX_LIB_FLAVOUR)_fl.lib  $(__WXLIB_CORE_p)  $(__WXLIB_BASE_p)  $(__WXLIB_MONO_p) $(__LIB_TIFF_p) $(__LIB_JPEG_p) $(__LIB_PNG_p)  wxzlib$(WXDEBUGFLAG).lib  wxregex$(WXUNICODEFLAG)$(WXDEBUGFLAG).lib wxexpat$(WXDEBUGFLAG).lib $(EXTRALIBS_FOR_BASE) upm32.lib) do @%append $(OBJS)\fl_sample3.lbc library %i
	@%append $(OBJS)\fl_sample3.lbc
