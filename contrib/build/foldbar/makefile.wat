...
FOLDBARDLL_CXXFLAGS = -bd $(__DEBUGINFO_1) $(__OPTIMIZEFLAG) -bm &
	...
	/fh=$(OBJS)\wxprec_foldbardll.pch $(__EXCEPTIONSFLAG) &
...
FOLDBARLIB_CXXFLAGS = $(__DEBUGINFO_1) $(__OPTIMIZEFLAG) -bm $(__RUNTIME_LIBS) &
	...
	-i=..\..\src\foldbar\..\..\..\include -i=$(SETUPHDIR) -wx -wcd=549 -wcd=656 &
	-wcd=657 -wcd=667 -i=..\..\src\foldbar\..\..\include &
	/fh=$(OBJS)\wxprec_foldbarlib.pch $(__EXCEPTIONSFLAG) &
	$(__EXCEPTIONSFLAG_0) $(CPPFLAGS) $(CXXFLAGS)
FOLDBARLIB_OBJECTS =  &
