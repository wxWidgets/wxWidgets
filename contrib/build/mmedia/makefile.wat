...
MMEDIALIB_CXXFLAGS = $(__DEBUGINFO_1) $(__OPTIMIZEFLAG) -bm $(__RUNTIME_LIBS) &
	...
	-i=..\..\src\mmedia\..\..\..\include -i=$(SETUPHDIR) -wx -wcd=549 -wcd=656 &
	-wcd=657 -wcd=667 -i=..\..\src\mmedia\..\..\include &
	/fh=$(OBJS)\wxprec_mmedialib.pch $(__EXCEPTIONSFLAG) $(__EXCEPTIONSFLAG_0) &
	$(CPPFLAGS) $(CXXFLAGS)
MMEDIALIB_OBJECTS =  &
...
!ifeq SHARED 1
$(LIBDIRNAME)\wx$(PORTNAME)$(WXUNIVNAME)$(WX_VERSION_NODOT)$(WXUNICODEFLAG)$(WXDEBUGFLAG)$(WX_LIB_FLAVOUR)_mmedia_wat$(VENDORTAG).dll :  $(MMEDIADLL_OBJECTS)
