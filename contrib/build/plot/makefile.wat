...
PLOTDLL_CXXFLAGS = -bd $(__DEBUGINFO_1) $(__OPTIMIZEFLAG) -bm $(__RUNTIME_LIBS) &
	...
	-i=..\..\src\plot\..\..\..\include -i=$(SETUPHDIR) -wx -wcd=549 -wcd=656 &
	-wcd=657 -wcd=667 -i=..\..\src\plot\..\..\include -dWXUSINGDLL &
	-dWXMAKINGDLL_PLOT /fh=$(OBJS)\wxprec_plotdll.pch $(__EXCEPTIONSFLAG) &
...
PLOTLIB_CXXFLAGS = $(__DEBUGINFO_1) $(__OPTIMIZEFLAG) -bm $(__RUNTIME_LIBS) &
	-d__WXMSW__ $(__WXUNIV_DEFINE_p) $(__DEBUG_DEFINE_p) $(__UNICODE_DEFINE_p) &
	-i=..\..\src\plot\..\..\..\include -i=$(SETUPHDIR) -wx -wcd=549 -wcd=656 &
	-wcd=657 -wcd=667 -i=..\..\src\plot\..\..\include &
	/fh=$(OBJS)\wxprec_plotlib.pch $(__EXCEPTIONSFLAG) $(__EXCEPTIONSFLAG_0) &
	$(CPPFLAGS) $(CXXFLAGS)
PLOTLIB_OBJECTS =  &
