...
SVGDLL_CXXFLAGS = -bd $(__DEBUGINFO_1) $(__OPTIMIZEFLAG) -bm $(__RUNTIME_LIBS) &
	...
	-i=..\..\src\svg\..\..\..\include -i=$(SETUPHDIR) -wx -wcd=549 -wcd=656 &
	-wcd=657 -wcd=667 -i=..\..\src\svg\..\..\include -dWXUSINGDLL &
	-dWXMAKINGDLL_SVG /fh=$(OBJS)\wxprec_svgdll.pch $(__EXCEPTIONSFLAG) &
...
SVGLIB_CXXFLAGS = $(__DEBUGINFO_1) $(__OPTIMIZEFLAG) -bm $(__RUNTIME_LIBS) &
	-d__WXMSW__ $(__WXUNIV_DEFINE_p) $(__DEBUG_DEFINE_p) $(__UNICODE_DEFINE_p) &
	-i=..\..\src\svg\..\..\..\include -i=$(SETUPHDIR) -wx -wcd=549 -wcd=656 &
	-wcd=657 -wcd=667 -i=..\..\src\svg\..\..\include &
	/fh=$(OBJS)\wxprec_svglib.pch $(__EXCEPTIONSFLAG) $(__EXCEPTIONSFLAG_0) &
	$(CPPFLAGS) $(CXXFLAGS)
SVGLIB_OBJECTS =  &
...
!ifeq SHARED 1
$(LIBDIRNAME)\wx$(PORTNAME)$(WXUNIVNAME)$(WX_VERSION_NODOT)$(WXUNICODEFLAG)$(WXDEBUGFLAG)$(WX_LIB_FLAVOUR)_svg_wat$(VENDORTAG).dll :  $(SVGDLL_OBJECTS)
