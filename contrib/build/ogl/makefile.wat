...
OGLDLL_CXXFLAGS = -bd $(__DEBUGINFO_1) $(__OPTIMIZEFLAG) -bm $(__RUNTIME_LIBS) &
	-d__WXMSW__ $(__WXUNIV_DEFINE_p) $(__DEBUG_DEFINE_p) $(__UNICODE_DEFINE_p) &
	-i=..\..\src\ogl\..\..\..\include -i=$(SETUPHDIR) -wx -wcd=549 -wcd=656 &
	-wcd=657 -wcd=667 -i=..\..\src\ogl\..\..\include -dWXUSINGDLL &
	-dWXMAKINGDLL_OGL /fh=$(OBJS)\wxprec_ogldll.pch $(__EXCEPTIONSFLAG) &
...
OGLLIB_CXXFLAGS = $(__DEBUGINFO_1) $(__OPTIMIZEFLAG) -bm $(__RUNTIME_LIBS) &
	-d__WXMSW__ $(__WXUNIV_DEFINE_p) $(__DEBUG_DEFINE_p) $(__UNICODE_DEFINE_p) &
	-i=..\..\src\ogl\..\..\..\include -i=$(SETUPHDIR) -wx -wcd=549 -wcd=656 &
	-wcd=657 -wcd=667 -i=..\..\src\ogl\..\..\include &
	/fh=$(OBJS)\wxprec_ogllib.pch $(__EXCEPTIONSFLAG) $(__EXCEPTIONSFLAG_0) &
	$(CPPFLAGS) $(CXXFLAGS)
OGLLIB_OBJECTS =  &
...
!ifeq SHARED 1
$(LIBDIRNAME)\wx$(PORTNAME)$(WXUNIVNAME)$(WX_VERSION_NODOT)$(WXUNICODEFLAG)$(WXDEBUGFLAG)$(WX_LIB_FLAVOUR)_ogl_wat$(VENDORTAG).dll :  $(OGLDLL_OBJECTS)
