...
FLDLL_CXXFLAGS = -bd $(__DEBUGINFO_1) $(__OPTIMIZEFLAG) -bm $(__RUNTIME_LIBS) &
	...
	-i=..\..\src\fl\..\..\..\include -i=$(SETUPHDIR) -wx -wcd=549 -wcd=656 &
	-wcd=657 -wcd=667 -i=..\..\src\fl\..\..\include -dWXUSINGDLL &
	-dWXMAKINGDLL_FL /fh=$(OBJS)\wxprec_fldll.pch $(__EXCEPTIONSFLAG) &
...
FLLIB_CXXFLAGS = $(__DEBUGINFO_1) $(__OPTIMIZEFLAG) -bm $(__RUNTIME_LIBS) &
	-d__WXMSW__ $(__WXUNIV_DEFINE_p) $(__DEBUG_DEFINE_p) $(__UNICODE_DEFINE_p) &
	-i=..\..\src\fl\..\..\..\include -i=$(SETUPHDIR) -wx -wcd=549 -wcd=656 &
	-wcd=657 -wcd=667 -i=..\..\src\fl\..\..\include &
	/fh=$(OBJS)\wxprec_fllib.pch $(__EXCEPTIONSFLAG) $(__EXCEPTIONSFLAG_0) &
	$(CPPFLAGS) $(CXXFLAGS)
FLLIB_OBJECTS =  &
...
!ifeq SHARED 1
$(LIBDIRNAME)\wx$(PORTNAME)$(WXUNIVNAME)$(WX_VERSION_NODOT)$(WXUNICODEFLAG)$(WXDEBUGFLAG)$(WX_LIB_FLAVOUR)_fl_wat$(VENDORTAG).dll :  $(FLDLL_OBJECTS)
