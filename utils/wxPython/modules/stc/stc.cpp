...
#endif
#define SWIG_init    initstcc

#define SWIG_name    "stcc"
...
#define wxStyledTextCtrl_GetCurrentLineText(_swigobj)  (_swigobj->GetCurrentLineText())
...
{
    wxPy_BEGIN_ALLOW_THREADS;
        _result = new wxString (wxStyledTextCtrl_GetCurrentLineText(_arg0));
...
#define wxStyledTextCtrl_SetFoldExpanded(_swigobj,_swigarg0)  (_swigobj->SetFoldExpanded(_swigarg0))
static PyObject *_wrap_wxStyledTextCtrl_SetFoldExpanded(PyObject *self, PyObject *args, PyObject *kwargs) {
    ...
    self = self;
    if(!PyArg_ParseTupleAndKeywords(args,kwargs,"Oi:wxStyledTextCtrl_SetFoldExpanded",_kwnames,&_argo0,&_arg1)) 
        return NULL;
    if (_argo0) {
        if (_argo0 == Py_None) { _arg0 = NULL; }
        else if (SWIG_GetPtrObj(_argo0,(void **) &_arg0,"_wxStyledTextCtrl_p")) {
...
static PyMethodDef stccMethods[] = {
...
extern "C" 
#endif
SWIGEXPORT(void) initstcc() {
	 PyObject *m, *d;
	 SWIG_globals = SWIG_newvarlink();
	 m = Py_InitModule("stcc", stccMethods);
	 ...
	 PyDict_SetItemString(d,"wxSTC_LEX_STYLE_MAX", PyInt_FromLong((long) wxSTC_LEX_STYLE_MAX));
	 PyDict_SetItemString(d,"wxSTC_STYLE_DEFAULT", PyInt_FromLong((long) wxSTC_STYLE_DEFAULT));
	 PyDict_SetItemString(d,"wxSTC_STYLE_LINENUMBER", PyInt_FromLong((long) wxSTC_STYLE_LINENUMBER));
	 PyDict_SetItemString(d,"wxSTC_STYLE_BRACELIGHT", PyInt_FromLong((long) wxSTC_STYLE_BRACELIGHT));
	 PyDict_SetItemString(d,"wxSTC_STYLE_BRACEBAD", PyInt_FromLong((long) wxSTC_STYLE_BRACEBAD));
	 PyDict_SetItemString(d,"wxSTC_STYLE_CONTROLCHAR", PyInt_FromLong((long) wxSTC_STYLE_CONTROLCHAR));
	 PyDict_SetItemString(d,"wxSTC_STYLE_MAX", PyInt_FromLong((long) wxSTC_STYLE_MAX));
	 PyDict_SetItemString(d,"wxSTC_STYLE_MASK", PyInt_FromLong((long) wxSTC_STYLE_MASK));
	 PyDict_SetItemString(d,"wxSTC_MARKER_MAX", PyInt_FromLong((long) wxSTC_MARKER_MAX));
	 PyDict_SetItemString(d,"wxSTC_MARK_CIRCLE", PyInt_FromLong((long) wxSTC_MARK_CIRCLE));
	 PyDict_SetItemString(d,"wxSTC_MARK_ROUNDRECT", PyInt_FromLong((long) wxSTC_MARK_ROUNDRECT));
	 PyDict_SetItemString(d,"wxSTC_MARK_ARROW", PyInt_FromLong((long) wxSTC_MARK_ARROW));
	 PyDict_SetItemString(d,"wxSTC_MARK_SMALLRECT", PyInt_FromLong((long) wxSTC_MARK_SMALLRECT));
	 PyDict_SetItemString(d,"wxSTC_MARK_SHORTARROW", PyInt_FromLong((long) wxSTC_MARK_SHORTARROW));
	 PyDict_SetItemString(d,"wxSTC_MARK_EMPTY", PyInt_FromLong((long) wxSTC_MARK_EMPTY));
	 PyDict_SetItemString(d,"wxSTC_INDIC_PLAIN", PyInt_FromLong((long) wxSTC_INDIC_PLAIN));
	 PyDict_SetItemString(d,"wxSTC_INDIC_SQUIGGLE", PyInt_FromLong((long) wxSTC_INDIC_SQUIGGLE));
	 PyDict_SetItemString(d,"wxSTC_INDIC_TT", PyInt_FromLong((long) wxSTC_INDIC_TT));
	 PyDict_SetItemString(d,"wxSTC_INDIC0_MASK", PyInt_FromLong((long) wxSTC_INDIC0_MASK));
	 PyDict_SetItemString(d,"wxSTC_INDIC1_MASK", PyInt_FromLong((long) wxSTC_INDIC1_MASK));
	 PyDict_SetItemString(d,"wxSTC_INDIC2_MASK", PyInt_FromLong((long) wxSTC_INDIC2_MASK));
	 PyDict_SetItemString(d,"wxSTC_INDICS_MASK", PyInt_FromLong((long) wxSTC_INDICS_MASK));
	 ...
	 PyDict_SetItemString(d,"wxSTC_CARET_SLOP", PyInt_FromLong((long) wxSTC_CARET_SLOP));
	 PyDict_SetItemString(d,"WXSTC_CARET_CENTER", PyInt_FromLong((long) WXSTC_CARET_CENTER));
	 PyDict_SetItemString(d,"wxSTC_CARET_STRICT", PyInt_FromLong((long) wxSTC_CARET_STRICT));
	 PyDict_SetItemString(d,"wxSTC_MARGIN_SYMBOL", PyInt_FromLong((long) wxSTC_MARGIN_SYMBOL));
	 PyDict_SetItemString(d,"wxSTC_MARGIN_NUMBER", PyInt_FromLong((long) wxSTC_MARGIN_NUMBER));
	 {
