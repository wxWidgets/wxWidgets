...
$(OBJS)\wxrc.exe :  $(WXRC_OBJECTS)
	...
	@%append $(OBJS)\wxrc.lbc  $(__DEBUGINFO_1)  libpath $(LIBDIRNAME) system os2v2 $(LDFLAGS)
	@for %i in ($(WXRC_OBJECTS)) do @%append $(OBJS)\wxrc.lbc file %i
	@for %i in ( $(__WXLIB_XML_p)  $(__WXLIB_BASE_p)  $(__WXLIB_MONO_p) wxzlib$(WXDEBUGFLAG).lib  wxregex$(WXUNICODEFLAG)$(WXDEBUGFLAG).lib wxexpat$(WXDEBUGFLAG).lib $(EXTRALIBS_FOR_BASE) upm32.lib) do @%append $(OBJS)\wxrc.lbc library %i
...
$(OBJS)\wxrc_wxrc.obj :  .AUTODEPEND .\wxrc.cpp
	$(CXX) -bt=os2 -zq -fo=$^@ $(WXRC_CXXFLAGS) $<
