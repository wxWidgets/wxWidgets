...
all : .SYMBOLIC $(__execmon___depname)
...
$(OBJS)\execmon.exe :  $(EXECMON_OBJECTS)
	@%create $(OBJS)\execmon.lbc
	@%append $(OBJS)\execmon.lbc option quiet
	@%append $(OBJS)\execmon.lbc name $^@
	@%append $(OBJS)\execmon.lbc option caseexact
	@%append $(OBJS)\execmon.lbc  $(__DEBUGINFO_1)  libpath $(LIBDIRNAME) system nt ref 'main_' $(____CAIRO_LIBDIR_FILENAMES_p) $(LDFLAGS)
	@for %i in ($(EXECMON_OBJECTS)) do @%append $(OBJS)\execmon.lbc file %i
	@for %i in ( $(__WXLIB_BASE_p)  $(__WXLIB_MONO_p) $(__LIB_PNG_IF_MONO_p) wxzlib$(WXDEBUGFLAG).lib wxregex$(WXUNICODEFLAG)$(WXDEBUGFLAG).lib wxexpat$(WXDEBUGFLAG).lib $(EXTRALIBS_FOR_BASE)  $(__CAIRO_LIB_p) kernel32.lib user32.lib gdi32.lib comdlg32.lib winspool.lib winmm.lib shell32.lib comctl32.lib ole32.lib oleaut32.lib uuid.lib rpcrt4.lib advapi32.lib wsock32.lib wininet.lib) do @%append $(OBJS)\execmon.lbc library %i
	@%append $(OBJS)\execmon.lbc
	@for %i in () do @%append $(OBJS)\execmon.lbc option stack=%i
	wlink @$(OBJS)\execmon.lbc
!endif

$(OBJS)\execmon_execmon.obj :  .AUTODEPEND .\execmon.cpp
	$(CXX) -bt=nt -zq -fo=$^@ $(EXECMON_CXXFLAGS) $<
